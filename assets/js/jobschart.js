            ...
            (t.prototype = {
                init: function (e) {
                    ...
                    return (
                        "object" === p.type(i)
                            ? i instanceof p
                                ? this.buildHierarchy(o, this.buildJsonDS(i.children()), 0, this.options)
                                : this.buildHierarchy(o, this.options.ajaxURL ? i : this.attachRel(i, "00"))
                            : (s.append('<i class="oci oci-spinner spinner"></i>'),
                                p
                        ...
                        t.append(s),
                        this.options.exportButton && !p(".oc-export-btn").length && this.attachExportButton(),
                ...
                bindZoom: function () {
                    this.$chartContainer.on("wheel", { oc: this }, this.zoomWheelHandler),
                        ...
                        p(f).on("touchmove", { oc: this }, this.zoomingHandler),
                        p(f).on("touchend", { oc: this }, this.zoomEndHandler);
                },
                unbindZoom: function () {
                ...
                setChartScale: function (e, t) {
                    ...
                    "none" === n
                        ...
                        : ((s = n.split(",")),
                            -1 === n.indexOf("3d")
                                ? (o = Math.abs(u.parseFloat(s[3]) * t)) > i.zoomoutLimit && o < i.zoominLimit && e.css("transform", n + " scale(" + t + "," + t + ")")
                                : (o = Math.abs(u.parseFloat(s[1]) * t)) > i.zoomoutLimit && o < i.zoominLimit && e.css("transform", n + " scale3d(" + t + "," + t + ", 1)"));
                                console.log(o);
                                //const keyboardSupport = document.getElementById('noUi-zoom-slider')
                                //keyboardSupport.noUiSlider.set(o);
                            },
                ...
                loopChart: function (e, t) {
                    ...
                    return (
                        t &&
                        p.each(n.data("nodeData"), function (e, t) {
                            s[e] = t;
                        }),
                        n
                            .siblings(".nodes")
                ...
                getNodeState: function (e, t) {
                    ...
                    if ("parent" === (t = t || "self")) {
                        if ((n ? (i = e.closest("ul").parents("ul")).length || (i = e.closest(".nodes")).length || (i = e.closest(".vertical").siblings(":first")) : (i = e.closest(".nodes").siblings(".node")), i.length))
                            return i.is(".hidden") || (!i.is(".hidden") && i.closest(".nodes").is(".hidden")) || (!i.is(".hidden") && i.closest(".vertical").is(".hidden")) ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 };
                    } else if ("children" === t) {
                        if ((i = n ? e.parent().children("ul") : e.siblings(".nodes")).length) return i.is(".hidden") ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 };
                    } else if ("siblings" === t) {
                        if ((i = n ? e.closest("ul") : e.parent().siblings()).length && (!n || 1 < i.children("li").length))
                            return i.is(".hidden") || i.parent().is(".hidden") || (n && i.closest(".vertical").is(".hidden")) ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 };
                    } else if ((i = e).length)
                        return (i.closest(".nodes").length && i.closest(".nodes").is(".hidden")) ||
                            (i.closest(".hierarchy").length && i.closest(".hierarchy").is(".hidden")) ||
                            (i.closest(".vertical").length && (i.closest(".nodes").is(".hidden") || i.closest(".vertical").is(".hidden")))
                            ? { exist: !0, visible: !1 }
                            : { exist: !0, visible: !0 };
                    return { exist: !1, visible: !1 };
                },
                getRelatedNodes: function (e, t) {
                    return e && e instanceof p && e.is(".node")
                        ? "parent" === t
                ...
                hideParent: function (e) {
                    ...
                    t.find(".spinner").length && e.closest(".orgchart").data("inAjax", !1),
                        ...
                        this.getNodeState(t).visible && t.addClass("sliding slide-down").one("transitionend", { parent: t }, this.hideParentEnd),
                ...
                hideChildren: function (e) {
                    ...
                    t.is(".vertical") || i.closest(".hierarchy").addClass("isCollapsedDescendant"),
                        (t.is(".vertical") || t.find(".vertical").length) && i.find(".oci-minus-square").removeClass("oci-minus-square").addClass("oci-plus-square"),
                        this.repaint(i.get(0)),
                        i.addClass("sliding slide-up").eq(0).one("transitionend", { animatedNodes: i, lowerLevel: t, node: e }, this.hideChildrenEnd.bind(this));
                },
                ...
                showChildren: function (e) {
                    ...
                    i || (n.filter(":not(:only-child)").closest(".hierarchy").addClass("isChildrenCollapsed"), n.closest(".hierarchy").removeClass("isCollapsedDescendant")),
                        this.repaint(n.get(0)),
                        n.addClass("sliding").removeClass("slide-up").eq(0).one("transitionend", { node: e, animatedNodes: n }, this.showChildrenEnd.bind(this));
                },
                hideSiblingsEnd: function (e) {
                    ...
                    e.data.animatedNodes.removeClass("sliding"),
                        ...
                        s.find(".nodes, .vertical").addClass("hidden").end().addClass("hidden"),
                ...
                hideSiblings: function (e, t) {
                    ...
                    n.eq(0).one("transitionend", { node: e, nodeContainer: i, direction: t, animatedNodes: n }, this.hideSiblingsEnd.bind(this));
                },
                ...
                showSiblings: function (e, t) {
                    ...
                    t
                        ? (n.removeClass(t + "-sibs"), n.is("[class*=-sibs]") || n.removeClass("isSiblingsCollapsed"), i.removeClass("isCollapsedSibling " + t + "-sibs"))
                        : (e.closest(".hierarchy").removeClass("isSiblingsCollapsed"), i.removeClass("isCollapsedSibling")),
                        this.getNodeState(e, "parent").visible ||
                        (e.closest(".hierarchy").removeClass("isAncestorsCollapsed"), s.removeClass("hidden"), this.repaint(s[0]), s.addClass("sliding").removeClass("slide-down").one("transitionend", this.showRelatedParentEnd));
                    var o = i.find(".node").filter(this.isVisibleNode.bind(this));
                    this.repaint(o.get(0)), o.addClass("sliding").removeClass("slide-left slide-right"), o.eq(0).one("transitionend", { node: e, visibleNodes: o }, this.showSiblingsEnd.bind(this));
                },
                startLoading: function (e) {
                    var t = this.$chart;
                    return (
                        (void 0 === t.data("inAjax") || !0 !== t.data("inAjax")) &&
                        (e.addClass("hidden"), e.parent().append('<i class="oci oci-spinner spinner"></i>').children().not(".spinner").css("opacity", 0.2), t.data("inAjax", !0), p(".oc-export-btn").prop("disabled", !0), !0)
                    );
                },
                ...
                nodeEnterLeaveHandler: function (e) {
                    ...
                    if (t.closest(".nodes.vertical").length) {
                        ...
                        "mouseenter"===e.type
                            ? t.children(".toggleBtn").length && ((i = this.getNodeState(t, "children").visible), n.toggleClass("oci-plus-square", !i).toggleClass("oci-minus-square", i))
                            : n.removeClass("oci-plus-square oci-minus-square");
                    } else {
                        var s = t.children(".topEdge"),
                            o = (t.children(".rightEdge"), t.children(".bottomEdge")),
                            a = t.children(".leftEdge");
                        "mouseenter"===e.type
                            ? (s.length && ((i = this.getNodeState(t, "parent").visible), s.toggleClass("oci-chevron-up", !i).toggleClass("oci-chevron-down", i)),
                                o.length && ((i = this.getNodeState(t, "children").visible), o.toggleClass("oci-chevron-down", !i).toggleClass("oci-chevron-up", i)),
                                a.length && this.switchHorizontalArrow(t))
                            : t.children(".edge").removeClass("oci-chevron-up oci-chevron-down oci-chevron-right oci-chevron-left");
                    };
                ...
                loadNodes: function (t, e, i) {
                    ...
                    var n = this;
                    this.options;
                    p.ajax({ url: e, dataType: "json" })
                        .done(function (e) {
                            n.$chart.data("inAjax") &&
                                ("parent" === t ? p.isEmptyObject(e) || n.addParent(i.parent(), e) : "children" === t ? e.children.length && n.addChildren(i.parent(), e[t]) : n.addSiblings(i.parent(), e.siblings ? e.siblings : e),
                ...
                hEdgeClickHandler: function (e) {
                    ...
                    if (s.exist) {
                        ...
                        if (n.toggleSiblingsResp) {
                            ...
                            t.is(".leftEdge")
                                ? o.is(".hidden")
                                    ? (this.showSiblings(i, "left"), this.triggerShowEvent(i, "siblings"))
                                    : (this.hideSiblings(i, "left"), this.triggerHideEvent(i, "siblings"))
                                : a.is(".hidden")
                                    ? (this.showSiblings(i, "right"), this.triggerShowEvent(i, "siblings"))
                                    : (this.hideSiblings(i, "right"), this.triggerHideEvent(i, "siblings"));
                        } else s.visible ? (this.hideSiblings(i), this.triggerHideEvent(i, "siblings")) : (this.showSiblings(i), this.triggerShowEvent(i, "siblings"));
                    } else if (this.startLoading(t)) {
                        var r = i[0].id,
                            d = this.getNodeState(i, "parent").exist
                                ? p.isFunction(n.ajaxURL.siblings)
                                    ? n.ajaxURL.siblings(i.data("nodeData"))
                                    : n.ajaxURL.siblings + r
                                : p.isFunction(n.ajaxURL.families)
                                    ? n.ajaxURL.families(i.data("nodeData"))
                                    : n.ajaxURL.families + r;
                ...
                toggleVNodes: function (e) {
                    ...
                    s.is(".sliding") ||
                        (t.toggleClass("oci-plus-square oci-minus-square"),
                            n.eq(0).is(".slide-up")
                                ...
                                : (n.addClass("sliding slide-up").eq(0).one("transitionend", { vNodes: n }, this.collapseVNodesEnd), n.find(".toggleBtn").removeClass("oci-minus-square").addClass("oci-plus-square")));
                },
                createGhostNode: function (e) {
                    ...
                    if (
                        ("l2r" === s.direction
                            ? ((h = o.offsetY * l), (c = o.offsetX * l))
                            : "r2l" === s.direction
                                ? ((h = n.outerWidth(!1) - o.offsetY * l), (c = o.offsetX * l))
                                : "b2t" === s.direction && ((h = n.outerWidth(!1) - o.offsetX * l), (c = n.outerHeight(!1) - o.offsetY * l)),
                            a)
                    ) {
                        ...
                        if (t.hasClass("allowedDrop")) {
                            ...
                            if ((this.$chart.trigger(s, { draggedNode: i, dragZone: n, dropZone: t }), !s.isDefaultPrevented())) {
                                if (t.siblings(".nodes").length) {
                                    ...
                                    t.append('<i class="edge verticalEdge bottomEdge oci"></i>').after('<ul class="nodes"></ul>').siblings(".nodes").append(i.find(".horizontalEdge").remove().end().closest(".hierarchy")),
                                        t.children(".title").length && t.children(".title").prepend('<i class="oci ' + this.$chart.data("options").parentNodeSymbol + ' symbol"></i>');
                                1 === n.siblings(".nodes").children(".hierarchy").length
                                    ? n.siblings(".nodes").children(".hierarchy").find(".node:first").find(".horizontalEdge").remove()
                                    : 0 === n.siblings(".nodes").children(".hierarchy").length && n.find(".bottomEdge, .symbol").remove().end().siblings(".nodes").remove();
                            }
                        }
                    } else this.$chart.triggerHandler({ type: "otherdropped.orgchart", draggedItem: i, dropZone: t });
                    
                    //on append show childrens
                    t.closest(".isChildrenCollapsed").removeClass('isChildrenCollapsed');
                    t.siblings("ul").removeClass('hidden');
                    t.siblings("ul").children().find(".slide-up").removeClass('slide-up');
                ...
                touchmoveHandler: function (e) {
                    if (this.touchHandled && !(e.touches && 1 < e.touches.length)) {
                        e.preventDefault(),
                            this.touchMoved || (this.filterAllowedDropNodes(p(e.currentTarget)), (this.touchDragImage = this.createDragImage(e, this.$chart.data("dragged")[0]))),
                            (this.touchMoved = !0),
                ...
                createDragImage: function (e, t) {
                    ...
                    return (this.touchDragImageOffset = { x: s.x - n.left, y: s.y - n.top }), (i.style.opacity = "0.5"), f.body.appendChild(i), i;
                },
                    ...
                    if (i && n) {
                        ...
                        requestAnimationFrame(function () {
                            ...
                            (t.position = "absolute"),
                                ...
                                (t.zIndex = "999999"),
                                s.touchDragImageOffset && ((t.left = Math.round(e.x - s.touchDragImageOffset.x) + "px"), (t.top = Math.round(e.y - s.touchDragImageOffset.y) + "px"));
                        });
                    }
                },
                ...
                createNode: function (i) {
                    ...
                    i.children &&
                        i[n.nodeId] &&
                        p.each(i.children, function (e, t) {
                            t.parentId = i[n.nodeId];
                        });
                    var t = p("<div" + (n.draggable ? ' draggable="true"' : "") + (i[n.nodeId] ? ' id="' + i[n.nodeId] + '"' : "") + (i.parentId ? ' data-parent="' + i.parentId + '"' : "") + ">").addClass(
                        "node " + (i.className || "") + (e > n.visibleLevel ? " slide-up" : "")
                    );
                    ...
                    n.nodeTemplate ? t.append(n.nodeTemplate(i)) : t.append(void 0 !== n.nodeTitle ? '<div class="org-box">' + '<div class="structure-tile">' + '<div class="dropdown dropdown-inline ml-auto org-chart-actions"> <a href="#" class="p-1 btn btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="ki ki-bold-more-hor"></i> </a> <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style=""><ul class="navi navi-hover my-0"><li class=""><a id="btn-add-nodes" class="text-dark-50"><i class="flaticon-plus mr-2"></i> <span class="align-self-center">Add Child</span></a></li><li class=""><a href="" class="edit-org-card text-dark-50"><img src="assets/media/images/edit-icon.svg" class="h-14 mr-2" alt=""> <span class="align-self-center">Edit</span></a></li> <li class=""><a id="btn-delete-nodes" class="text-dark-50"><i class="flaticon-delete mr-2"></i> <span class="align-self-center">Delete</span></a></li></ul></div></div> <figure><span><img src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-png-webinar-optimizing-for-success-google-business-webinar-13.png"></span></figure>' + '<h2 class="orgTitle text-secondary">' + (i[n.nodeTitle] || "") + '</h2>' + "<div class='competency-details-top text-center'><div class='d-flex justify-content-center mt-2'><p class='align-self-center mr-2 CDI-span orgID text-center mb-0 w-auto px-2'>" + 'C' + "</p>" + '<span class="text-success font-weight-500">'+ (i[n.jobID] || "") +'</span>' + "</div></div>" + "</div>" + "</div>" : "");

                    var s = p.extend({}, i);
                    delete s.children, t.data("nodeData", s);
                    var o = i.relationship || "";
                    return (
                        n.verticalLevel && e >= n.verticalLevel
                            ? e + 1 > n.verticalLevel &&
                            Number(o.substr(2, 1)) &&
                            t
                                .append('<i class="toggleBtn oci"></i>')
                                .children(".title")
                                .prepend('<i class="oci ' + n.parentNodeSymbol + ' symbol"></i>')
                            : (Number(o.substr(0, 1)) && t.append('<i class="edge verticalEdge topEdge oci"></i>'),
                                Number(o.substr(1, 1)) && t.append('<i class="edge horizontalEdge rightEdge oci"></i><i class="edge horizontalEdge leftEdge oci"></i>'),
                                Number(o.substr(2, 1)) &&
                                t
                        ...
                        t.on("click", ".leftEdge, .rightEdge", this.hEdgeClickHandler.bind(this)),
                        t.on("click", ".toggleBtn", this.toggleVNodes.bind(this)),
                        n.draggable && (this.bindDragDrop(t), (this.touchHandled = !1), (this.touchMoved = !1), (this.touchTargetNode = null)),
                ...
                buildHierarchy: function (e, t) {
                    ...
                    if (t.children && t.children.length) {
                        var a,
                            r = s + 1 > n.visibleLevel || (t.collapsed !== d && t.collapsed);
                        n.verticalLevel && s + 1 >= n.verticalLevel
                            ? ((a = p('<ul class="nodes">')), r && s + 1 >= n.verticalLevel && a.addClass("hidden"), s + 1 === n.verticalLevel ? e.addClass("hybrid").append(a.addClass("vertical")) : e.append(a))
                            : ((a = p('<ul class="nodes' + (r ? " hidden" : "") + '">')), 2 === Object.keys(t).length || (r && e.addClass("isChildrenCollapsed")), e.append(a)),
                            p.each(t.children, function () {
                ...
                addChildren: function (e, t) {
                    this.buildChildNode(e.closest(".hierarchy"), t),
                        e.find(".symbol").length || e.children(".title").prepend('<i class="oci ' + this.options.parentNodeSymbol + ' symbol"></i>'),
                        e.closest(".nodes.vertical").length ? e.children(".toggleBtn").length || e.append('<i class="toggleBtn oci"></i>') : e.children(".bottomEdge").length || e.append('<i class="edge verticalEdge bottomEdge oci"></i>'),
                        this.isInAction(e) && this.switchVerticalArrow(e.children(".bottomEdge"));
                        var nodeId = t[0].id;
                        this.startEdit(e, nodeId);
                },
                startEdit: function(e, id){
                    var nodeName="";
                    var inputElement = $('<input class="org-input form-control w-100" type="text" value="'+nodeName+'"/>');
                    this.$chartContainer.find('div[id='+id+'] .structure-tile h2').replaceWith(inputElement);
                    var commitChange = function(){
                        var h2Element = $('<h2>'+nodeName+'</h2>');
                ...
                addSiblings: function (e, t) {
                    this.buildSiblingNode(e.closest(".hierarchy"), t),
                        ...
                        e.children(".leftEdge").length || e.children(".topEdge").after('<i class="edge horizontalEdge rightEdge oci"></i><i class="edge horizontalEdge leftEdge oci"></i>'),
                        this.isInAction(e) && (this.switchHorizontalArrow(e), e.children(".topEdge").removeClass("oci-chevron-up").addClass("oci-chevron-down"));
                        var nodeId = t[0].id;
                        this.startEdit(e, nodeId);
                },
                removeNodes: function (e) {
                    ...
                    t.parent().is(".hierarchy")
                        ? this.getNodeState(e, "siblings").exist
                            ? (e.closest(".hierarchy").fadeOut(400, 'swing', function(){e.closest(".hierarchy").remove()}), 1 === t.children().length && t.find(".node:first .horizontalEdge").fadeOut(400, 'swing', function(){t.find(".node:first .horizontalEdge").remove()}))
                            : t.siblings(".node").find(".bottomEdge").fadeOut(400, 'swing', function(){t.siblings(".node").find(".bottomEdge").remove().end().end().fadeOut(100, 'swing', function(){t.siblings(".node").find(".bottomEdge").remove().end().end().remove()})})
                        : t.closest(".orgchart").fadeOut(400, 'swing', function(){t.closest(".orgchart").remove()});
                },
                ...
                exportPDF: function (e, t) {
                    ...
                    u.jsPDF || (u.jsPDF = u.jspdf.jsPDF),
                        (i = s < n ? new jsPDF({ orientation: "landscape", unit: "px", format: [n, s] }) : new jsPDF({ orientation: "portrait", unit: "px", format: [s, n] })).addImage(e.toDataURL(), "png", 0, 0),
                        i.save(t + ".pdf");
                },
