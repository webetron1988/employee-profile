...
!(function (e) {
    ...
    (t.prototype = {
        ...
        hideChildren: function (e) {
            e.closest(".node").addClass("isChildrenCollapsed");
        ...
        showChildren: function (e) {
            e.closest(".node").removeClass("isChildrenCollapsed");
            var t = e.closest("tr").siblings(),
        ...
        createNode: function (i) {
            ...
            var n = v("<div" + (e.draggable ? ' draggable="true"' : "") + (i[e.nodeId] ? ' id="' + i[e.nodeId] + '"' : "") + (i.parentId ? ' data-parent="' + i.parentId + '"' : "") + ">").addClass(
                "node w-auto " + (i.className || "") + (t > e.visibleLevel ? " slide-up" : "")
            );
            e.nodeTemplate ? n.append(e.nodeTemplate(i)) : n.append(void 0 !== e.nodeContent ? '<div class="content-v2 "><a href="" class="text-primary font-weight-bold font-14"><img class="h-20" src="'+ i[e.nodeImg] +'"></a> <a href="" class="title">' + i[e.nodeTitle] + "</a> <div class='d-flex align-items-center justify-content-center'> <div class='label label-inline label-light-primary'> Code: STRP0001 </div> </div> <div class='d-flex justify-content-center mt-2'> <span class='align-self-center d-flex'> <span class='label label-inline label-sm label-light-danger d-flex align-items-center'> <span class='align-self-center mr-2 line-height-0'> <img src='assets/media/images/high-potential.svg' alt=''> </span> <span class='align-self-center'>High</span> </span><span class='dash bg-gray-500'></span> <span class='bg-danger dot dot-lg ml-0'></span> Todo </span> </div> <div class='d-flex justify-content-center w-100 mt-2'> <div class='data-sub-title font-12 text-success'> 05 Jan, 2024</div> <span class='mx-2 align-self-center line-height-0'> <img src='assets/media/images/daterange-danger.svg' alt='' class='filter-grayscale'> </span> <div class='data-sub-title font-12 text-danger'> 09 Dec, 2024</div> </div> <div class='px-5 d-flex align-items-center font-13 text-dark mt-3 gap-10'><span class='w-100 keyresult-target-hierarchy readonly success-slider slider-bg-warning'> <input type='hidden' class='kt_slider_1' /> </span><span class='text-nowrap font-12 mt-auto'>" + "$" + (i[e.nodeContent] || "") +"M"+ "</span> </div> <div class='approval-timeline-collaborators mt-2'> <div class='symbol-group symbol-hover justify-content-center collaborater-type1'> <div class='symbol symbol-25 symbol-circle'> <div class='symbol-label font-weight-bold bg-primary text-white' data-container='.chart-container-v2-outer' data-toggle='tooltip' title='' data-original-title='<strong>Nick Mana</strong>' data-theme='dark' data-trigger='hover' data-html='true'> CS </div> </div> <div class='symbol symbol-25 symbol-circle'> <img alt='Pic' src='assets/media/users/300_18.jpg'> </div> <div class='symbol symbol-25 symbol-circle'> <img alt='Pic' src='assets/media/users/300_25.jpg'> </div> <div class='symbol symbol-25 w-auto symbol-circle' data-trigger='hover' data-toggle='popover' data-container='.chart-container-v2-outer' data-placement='bottom' data-html='true' data-content='test'> <span class='symbol-label font-weight-bold'>+5</span> </div> </div> </div> </div>" : ""); var s = v.extend({}, i); delete s.children, n.data("nodeData", s);
        ...
        buildHierarchy: function (e, t) {
            ...
            $(function () {
                ...
                $('[data-toggle="tooltip"]').each(function() {
                    ...
                    $(el).tooltip({
                      trigger: trigger,
                      template: '<div class="tooltip ' + theme + ' ' + width + '" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>'
                    });
                  }); 
            ...
            var demos = function () {
                ...
                $('.kt_slider_1').ionRangeSlider({
                    ...
                    onStart: function (data) {
                        var id = $(data.slider[0]['parentNode']).attr('id');
                        if (data.from_percent == 100) {
                            $(data.slider[0]['parentNode']).find('.irs-bar').addClass('w-100');
                        }
                        else if (data.from_percent > 100) {
                            $(data.slider[0]['parentNode']).find('.irs-bar').removeClass('w-100');
                        }
                    },
