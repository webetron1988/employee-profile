...
(function ($) {
    ...
    $(function () {
        ...
        var dataset = [
            { id: 1, className:'parentCard', lineColor:'-gray-600', name: 'Google', roleStatus: '', parent_id: null },
            { id: 2, name: 'IT', lineColor:'-primary', roleStatus: '3', parent_id: 1 },
            { id: 3, name: 'Manufacturing', lineColor:'-warning', roleStatus:'2', parent_id: 1 },
            { id: 4, name: 'E-Commerce', lineColor:'-danger', roleStatus:'3', parent_id: 1 },
            { id: 5, name: 'HR', lineColor:'-primary', roleStatus: '3', parent_id: 1 },
            { id: 6, name: 'Development', lineColor:'-success', roleStatus: '2', parent_id: 2 },
            { id: 7, name: 'Design', lineColor:'-success', roleStatus: '3', parent_id: 2 },
            { id: 8, name: 'Testing', lineColor:'-success', roleStatus:'3', parent_id: 2 },
            { id: 9, name: 'Java Developer', lineColor:'-success', roleStatus: '2', parent_id: 6 },
            { id: 10, name: 'Python Developer', lineColor:'-primary', roleStatus: '1', parent_id: 6 },
            { id: 10, name: 'React Developer', lineColor:'-success', roleStatus: '3', parent_id: 6 }];
        ...
        $(".roleHierarchy li .nodes li figure").remove()
    });
})(jQuery, JSONLoop);
