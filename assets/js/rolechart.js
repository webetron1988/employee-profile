        ...
        !(function (e) {
            ...
            (t.prototype = {
                ...
                createNode: function (i) {
                    ...
                    n.nodeTemplate ? t.append(n.nodeTemplate(i)) : t.append(void 0 !== n.nodeTitle ? '<div class="org-box role-hierarchy-tile border-light'+ (i[n.lineColor] || "") +'">' + '<div class="structure-tile">' + '<div class="node-line bg'+ (i[n.lineColor] || "") +'"></div>' + '<figure><span><img src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-png-webinar-optimizing-for-success-google-business-webinar-13.png"></span></figure>' + '<div class="d-flex justify-content-center">' + '<h2 class="orgTitle text-secondary">' + (i[n.nodeTitle] || "") + '</h2>' + '<div class="competency-chart-actions d-flex justify-content-center"><div class="align-self-center mr-2"><btn class="btn btn-light-primary" data-toggle="modal" data-target="#add-competency-modal"><i class="la la-plus"></i></btn></div><div class="align-self-center"><btn class="btn btn-light-primary" data-toggle="modal" data-target="#link-competency-modal" id="open-link-competency"><i class="la la-link"></i></btn></div></div>' + "<div class='competency-details-top text-center'><div class='d-flex justify-content-center mt-2'>" + '<span class="ml-2 label text-white bg'+ (i[n.lineColor] || "") +'">'+ (i[n.roleStatus] || "") +'</span>' + "</div></div>" + "</div>" + "</div>" + "</div>" : "");
