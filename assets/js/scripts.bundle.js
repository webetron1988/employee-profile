...
var KTCard = function(elementId, options) {
    ...
    var Plugin = {
        ...
        init: function(options) {
            ...
            the.header = KTUtil.child(element, '.card-header1');
        ...
        build: function() {
            ...
            if (closeBy) {
                KTUtil.addEvent(closeBy, 'click', function(e) {
                   /* The above code is preventing the default behavior of an event (e.g., a form
                   submission or a link click) using `e.preventDefault()`. It then sets the target
                   of the event to `this` and hides a plugin using `Plugin.hide()`. */
                    e.preventDefault();
                    the.target = this;
                    Plugin.hide();
                });
...
KTUtil.ready(function() {
    ...
    KTLayoutDemoPanel_1.init('kt_demo_panel_1');

    KTLayoutDemoPanel_2.init('kt_demo_panel_2');
    
    KTLayoutDemoPanel_3.init('kt_demo_panel_3');
    
    KTLayoutDemoPanel_4.init('kt_demo_panel_4');
    
    KTLayoutDemoPanel_5.init('kt_demo_panel_5');

    KTLayoutDemoPanel_6.init('kt_demo_panel_6');
    
    KTLayoutDemoPanel_7.init('kt_demo_panel_7');

    KTLayoutDemoPanel_8.init('kt_demo_panel_8');

    KTLayoutDemoPanel_9.init('kt_demo_panel_9');

    KTLayoutDemoPanel_10.init('kt_demo_panel_10');

    // Init Quick Hidden Cards Panel
    KTLayoutQuickHiddenCardsPanel.init('kt_quick_hiddenCards');
    ...
    // Init swot details Panel
    if (typeof KTLayoutSwotDetails !== 'undefined') {
        KTLayoutSwotDetails.init('kt_swot_details');
    }

    //add task panel
    if (typeof KTLayoutAddTask !== 'undefined') {
        KTLayoutAddTask.init('kt_add_task');
    }

    //Policy-details and sub chapters show panel
    if (typeof KTLayoutPolicyShow !== 'undefined') {
        KTLayoutPolicyShow.init('kt_show_policy_sec');
    }

    //swot comments panel
    if (typeof KTLayoutSwotComments !== 'undefined') {
        KTLayoutSwotComments.init('kt_swot_comments');
    }

    // approval timeline
    if (typeof KTLayoutJobApproval !== 'undefined') {
        KTLayoutJobApproval.init('kt_job_approval');
    }
...
// custom  panel 1
var KTLayoutDemoPanel_1 = function() {
    // Private properties
    var _element;
    var _offcanvasObject1;

    // Private functions
    var _init = function() {
        _offcanvasObject1 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_1',
            toggleBy: 'kt_demo_panel_toggle_1'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject1) {
                _offcanvasObject1.hide();
            }
        }
    };
}();
...
if (typeof module !== 'undefined') {
	module.exports = KTLayoutDemoPanel_1;
}


// custom  panel 2
var KTLayoutDemoPanel_2 = function() {
    // Private properties
    var _element;
    ...
    var _init = function() {
        _offcanvasObject2 = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_2',
            toggleBy: 'kt_demo_panel_toggle_2'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject2) {
                _offcanvasObject2.hide();
            }
        }
    };
}();
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutDemoPanel_2;
}

// custom  panel 3
var KTLayoutDemoPanel_3 = function() {
    // Private properties
    var _element;
    var _offcanvasObject3;

    // Private functions
    var _init = function() {
        _offcanvasObject3 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_3',
            toggleBy: 'kt_demo_panel_toggle_3'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject3) {
                _offcanvasObject3.hide();
            }
        }
    };
}();
...
// custom  panel 4
var KTLayoutDemoPanel_4 = function() {
    // Private properties
    var _element;
    var _offcanvasObject4;

    // Private functions
    var _init = function() {
        _offcanvasObject4 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_4',
            toggleBy: 'kt_demo_panel_toggle_4'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject4) {
                _offcanvasObject4.hide();
            }
        }
    };
}();
...
// custom  panel 5
var KTLayoutDemoPanel_5 = function() {
    // Private properties
    var _element;
    var _offcanvasObject5;

    // Private functions
    var _init = function() {
        _offcanvasObject5 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_5',
            toggleBy: 'kt_demo_panel_toggle_5'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject5) {
                _offcanvasObject5.hide();
            }
        }
    };
}();
...
// custom  panel 6
var KTLayoutDemoPanel_6 = function() {
    // Private properties
    var _element;
    var _offcanvasObject6;

    // Private functions
    var _init = function() {
        _offcanvasObject6 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_6',
            toggleBy: 'kt_demo_panel_toggle_6'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject6) {
                _offcanvasObject6.hide();
            }
        }
    };
}();
...
// custom  panel 7
var KTLayoutDemoPanel_7 = function() {
    // Private properties
    var _element;
    var _offcanvasObject7;

    // Private functions
    var _init = function() {
        _offcanvasObject7 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_7',
            toggleBy: 'kt_demo_panel_toggle_7'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject7) {
                _offcanvasObject7.hide();
            }
        }
    };
}();
...
// custom  panel 8
var KTLayoutDemoPanel_8 = function() {
    // Private properties
    var _element;
    var _offcanvasObject8;

    // Private functions
    var _init = function() {
        _offcanvasObject8 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_8',
            toggleBy: 'kt_demo_panel_toggle_8'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject8) {
                _offcanvasObject8.hide();
            }
        }
    };
}();
...
// custom  panel 9
var KTLayoutDemoPanel_9 = function() {
    // Private properties
    var _element;
    var _offcanvasObject9;

    // Private functions
    var _init = function() {
        _offcanvasObject9 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_9',
            toggleBy: 'kt_demo_panel_toggle_9'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject9) {
                _offcanvasObject9.hide();
            }
        }
    };
}();
...
// custom  panel 10
var KTLayoutDemoPanel_10 = function() {
    // Private properties
    var _element;
    var _offcanvasObject10;

    // Private functions
    var _init = function() {
        _offcanvasObject10 = new KTOffcanvas(_element, {
            overlay: true,
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel_close_10',
            toggleBy: 'kt_demo_panel_toggle_10'
        });
    ...
    return {
        ...
        close: function() {
            if (_offcanvasObject10) {
                _offcanvasObject10.hide();
            }
        }
    };
}();
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutDemoPanel_4;
}

// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutDemoPanel_3;
}
...
var KTLayoutStretchedCard = function() {
	...
	var _init = function() {
		...
		var cardHeader = KTUtil.find(_element, '.card-header1');
...
var KTLayoutChat = function () {
	...
	var _init = function (element) {
		...
		var cardHeaderEl = KTUtil.find(element, '.card-header1');
...
var KTLayoutQuickHiddenCardsPanel = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_hiddencards_close',
            toggleBy: 'kt_quick_hiddencards_toggle'
        });
...
if (typeof module !== 'undefined') {
	module.exports = KTLayoutQuickHiddenCardsPanel;
}
...
var KTLayoutSwotDetails = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_swot_details_close',
            toggleBy: 'kt_swot_details_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutSwotDetails;
}

//add task
var KTLayoutAddTask = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_add_task_close',
            toggleBy: 'kt_add_task_toggle'
        });
 ...
 //Policy-details and sub chapters show panel
var KTLayoutPolicyShow = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_show_policy_sec_close',
            toggleBy: 'kt_show_policy_sec_toggle'
        });
...
//add task
var KTLayoutSwotComments = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_swot_comments_close',
            toggleBy: 'kt_swot_comments_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutSwotComments;
}


//Approveal Timeline task
var KTLayoutJobApproval = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_job_approval_close',
            toggleBy: 'kt_job_approval_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutJobApproval;
}
...
$( ".dash-inner-tabs ol" ).wrap( "<div class='innTabsWidth'></div>" );
$( ".main-dashboard-tabs ul" ).wrap( "<div class='mainTabsWidth'></div>" );
