...
jQuery.fn.calendarPicker = function(options) {
  ...
  var divYears = $("<div style='display:none'>").addClass("calYear");
  var divMonths = $("<div style='display:none'>").addClass("calMonth");
  ...
  calendar.changeDate = function(date) {
    ...
    var fillMonths = function(date) {
      ...
      var w = parseInt((theDiv.width()-4-(nc)*20)/nc)+"px";
    ...
    var fillDays = function(date) {
      ...
      var w = parseInt((theDiv.width()-4-(options.showDayArrows?12:0)-(nc)*4))+"px";
