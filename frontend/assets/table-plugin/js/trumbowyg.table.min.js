...
!(function (e) {
    ...
    var t = {
        ...
        dropdown: [
            { title: "tableRows", buttons: ["tableAddHeaderRow", "tableAddRowAbove", "tableAddRow", "tableDeleteRow"] },
            { title: "tableColumns", buttons: ["tableAddColumnLeft", "tableAddColumn", "tableDeleteColumn"] },
            { title: "tableVerticalAlign", buttons: ["tableVerticalAlignTop", "tableVerticalAlignMiddle", "tableVerticalAlignBottom"] },
            { title: "tableOthers", buttons: ["tableMergeCells", "tableUnmergeCells", "tableDestroy"] },
        ],
    };
    function l(e) {
    ...
    e.extend(!0, e.trumbowyg, {
        langs: {
            ...
            cs: { table: "Vytvořit příkaz Table", tableAddRow: "Přidat řádek", tableAddRowAbove: "Přidat řádek", tableAddColumnLeft: "Přidat sloupec", tableAddColumn: "Přidat sloupec" },
            da: {
                table: "Indsæt tabel",
            ...
            ja: { table: "表の挿入", tableAddRow: "行の追加", tableAddRowAbove: "行の追加", tableAddColumnLeft: "列の追加", tableAddColumn: "列の追加" },
            ko: { table: "표 넣기", tableAddRow: "줄 추가", tableAddRowAbove: "줄 추가", tableAddColumnLeft: "칸 추가", tableAddColumn: "칸 추가", tableDeleteRow: "줄 삭제", tableDeleteColumn: "칸 삭제", tableDestroy: "표 지우기" },
            pt_br: {
            ...
            sk: { table: "Vytvoriť tabuľky", tableAddRow: "Pridať riadok", tableAddRowAbove: "Pridať riadok", tableAddColumnLeft: "Pridať stĺpec", tableAddColumn: "Pridať stĺpec" },
            tr: {
                table: "Tablo ekle",
            ...
            zh_tw: { table: "插入表格", tableAddRow: "加入行", tableAddRowAbove: "加入行", tableAddColumnLeft: "加入列", tableAddColumn: "加入列", tableDeleteRow: "刪除行", tableDeleteColumn: "刪除列", tableDestroy: "刪除表格" },
            es: {
                    ...
                    var n = {
                            fn: function () {
                                ...
                                var t = "table",
                                    ...
                                    n = { class: l + "-" + t + " " + l + " " + a.o.prefix + "fixed-top" };
                                n["data-" + l] = t;
                                var d = e("<div/>", n);
                                if (
                                    (0 === a.$box.find("." + l + "-" + t).length ? a.$box.append(d.hide()) : (d = a.$box.find("." + l + "-" + t)),
                                    d.html(""),
                                    a.$box.find("." + a.o.prefix + "table-button").hasClass(a.o.prefix + "active-button"))
                                ) {
                                    var i = e(a.doc.getSelection().anchorNode).closest("table"),
                                        c = b(i),
                                        u = void 0 !== o;
                                    e(a.o.plugins.table.dropdown).each(function (t, l) {
                                        d.append(e("<div/>", { html: a.lang[l.title] ? a.lang[l.title] : l.title, class: a.o.prefix + "table-dropdown-title" })).text();
                                        var o = e("<div/>", { class: a.o.prefix + "dropdown-button-group" });
                        ...
                        s = function () {
                            ...
                            var t = e("<table/>"),
                                ...
                                o = e("<tr/>");
                            o.appendTo(l);
                            for (var n = 0; n <= this.cellIndex; n += 1) e("<th/>", { scope: "col" }).appendTo(o);
                            l.appendTo(t);
                            ...
                            t.addClass("table table-bordered table-rounded");
                            t.wrap('<div class="plugin-table-outer position-relative m-0"></div>'); //custom
                            t.parent(".plugin-table-outer").append('<span class="plugin-table-top d-inline-flex align-items-center gap-5"><span onclick="clearDiv(this)" class="min-w-25px cursor-pointer min-h-20px">Top</span> <i class="la la-times text-danger cursor-pointer" onclick="removeParent(this)"></i></span><span class="plugin-table-right d-inline-flex align-items-center gap-5"><span onclick="clearDiv(this)" class="min-w-25px cursor-pointer min-h-20px">Right</span> <i class="la la-times text-danger cursor-pointer" onclick="removeParent(this)"></i></span><span class="plugin-table-bottom d-inline-flex align-items-center gap-5"><span onclick="clearDiv(this)" class="min-w-25px cursor-pointer min-h-20px">Bottom</span> <i class="la la-times text-danger cursor-pointer" onclick="removeParent(this)"></i></span><span class="plugin-table-left d-inline-flex align-items-center gap-5"><span onclick="clearDiv(this)" class="min-w-25px cursor-pointer min-h-20px">Left</span> <i class="la la-times text-danger cursor-pointer" onclick="removeParent(this)"></i></span>') //custom
                        },
                        b = function (t) {
                            ...
                            return (
                                l.each(function (t, l) {
                                    ...
                                    e("td, th", e(l)).each(function (l, n) {
                                        ...
                                        a[t][o] = { tag: n.tagName, element: n, colspan: s, rowspan: b };
                                        for (var c = 1; c < s; c += 1) a[t][o + c] = { mergedIn: [t, o] };
                                        for (var u = 1; u < b; u += 1) {
                                            a[t + u][o] = { mergedIn: [t, o] };
                                            for (var f = 1; f < s; f += 1) a[t + u][o + f] = { mergedIn: [t, o] };
                                        }
                                        o += s;
                                    });
                                }),
                        ...
                        f = { title: a.lang.tableAddRowAbove, text: a.lang.tableAddRowAbove, ico: "row-above", fn: u(!0) },
                        g = { title: a.lang.tableAddRow, text: a.lang.tableAddRow, ico: "row-below", fn: u(!1) },
                        p = {
                        ...
                        A = { title: a.lang.tableAddColumnLeft, text: a.lang.tableAddColumnLeft, ico: "col-left", fn: m(!0) },
                        v = { title: a.lang.tableAddColumn, text: a.lang.tableAddColumn, ico: "col-right", fn: m(!1) },
                        h = {
                            title: a.lang.tableDestroy,
                            text: a.lang.tableDestroy,
                            ico: "table-delete",
                            fn: c(function (e) {
                                e.parent().remove(); //custom
                                e.remove();
                            }),
                        },
                        w = {
                                    ...
                                    (function (t) {
                                        ...
                                        if (
                                            (e(o).each(function (e, l) {
                                                for (var a = l[0], o = l[1], d = t[a][o], i = a + d.rowspan; a < i; a += 1)
                                                    void 0 === n[a] && (n[a] = t[0].length), void 0 === r[a] && (r[a] = 0), (n[a] = Math.min(n[a], o)), (r[a] = Math.max(r[a], o + d.colspan));
                                            }),
                        ...
                        y = {
                            ...
                            fn: c(function (t, l, o, n) {
                                L(function (l) {
                                    ...
                                    for (var o = e("tr", t).index(l.closest("tr")), r = B(l[0], n[o]), d = n[o][r], i = 0; i < d.rowspan; i += 1)
                                        for (var s = 0 === i ? 1 : 0, b = D(n, [o + i, r + s - 1]).element; s < d.colspan; s += 1) {
                        ...
                        T(),
                            ...
                            e(a.doc).on("selectionchange.tbwTable", function () {
                                ...
                                var s = e(n).closest("td, th"),
                                    ...
                                    u = s.closest("table"),
                                    f = c.closest("table");
                                if ((e('[class="' + I + '"]', a.$ed).removeAttr("class"), e("." + I, a.$ed).removeClass(I), (0 === u.length && 0 === f.length) || u[0] !== f[0] || s[0] === c[0])) e("." + k, a.$ed).removeClass(k);
                                else {
                                    u.addClass(k);
                                    var g = b(u),
                                        p = e("tr", u),
                    ...
                    var L = function (t, l) {
                        ...
                        z = function () {
                            if (a.o.plugins.table.allowHorizontalResize) {
                                var t,
                                    ...
                                    r = n.length > 0;
                                r ||
                                    ((n = e("<div/>", { class: a.o.prefix + "table-resize-layers" }).appendTo(a.$edBox)),
                                    e(a.o.prefix + "table-resize-vertical-handle", n).each(function (t, l) {
                                        e(l).off().remove();
                                    })),
                                    e("table", a.$ed).each(function (r, d) {
                                        e("td, th", e(d)).each(function (r, d) {
                                            e("<div/>", { class: a.o.prefix + "table-resize-vertical-handle" })
                                                .prop(S, d)
                                                .on("mousedown.tbwTable", function (a) {
                                                    ...
                                                    var r = e("tr", o),
                                                        ...
                                                        c = B(n, s),
                                                        u = t[i][c];
                                                    void 0 !== u.mergedIn && (u = t[u.mergedIn[0]][u.mergedIn[1]]), (l = c + u.colspan - 1), M(o, t), E(o, t), o.css({ maxWidth: "" });
                                                })
                                                .appendTo(n);
                                        });
                                    }),
                        ...
                        H = function () {
                            ...
                            e("." + a.o.prefix + "table-resize-vertical-handle", t).each(function (t, l) {
                                ...
                                a.css({ top: r.top - o, left: r.left - n + r.width, height: r.height });
                            });
                        },
                        P = function (e) {
                            return c(function (t, l, a, o) {
                                L(function (t) {
                                    t.css({ verticalAlign: e });
                                }, o);
                            });
                        },
                        j = { title: a.lang.tableVerticalAlignTop, text: a.lang.tableVerticalAlignTop, ico: "align-top", fn: P("top") },
                        O = { title: a.lang.tableVerticalAlignMiddle, text: a.lang.tableVerticalAlignMiddle, ico: "align-middle", fn: P("middle") },
                        U = { title: a.lang.tableVerticalAlignBottom, text: a.lang.tableVerticalAlignBottom, ico: "align-bottom", fn: P("bottom") },
                        F = function (e) {
                        ...
                        Q = function (t, o, n, r, d) {
                            ...
                            e.each(o, function (e, l) {
                                var o = t + l,
                                    n = { fn: d("#" + l), hasIcon: !1, text: a.lang["#" + l] || "#" + l, style: "background-color: #" + l + ";" };
                                a.addBtnDef(o, n), i.push(o);
                            });
                            var b = "remove" + l(t),
                                c = { fn: d(""), hasIcon: !1, style: "background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAG0lEQVQIW2NkQAAfEJMRmwBYhoGBYQtMBYoAADziAp0jtJTgAAAAAElFTkSuQmCC);" };
                            if ((n && (c.style = ""), a.addBtnDef(b, c), i.push(b), s.allowCustomBackgroundColor)) {
                                var u = {
                                        fn: function () {
                                            a.openModalInsert(a.lang.backgroundColor, { color: { label: "backgroundColor", forceCss: !0, type: "color", value: "#FFFFFF" } }, function (e) {
                                                return d(e.color)(), !0;
                                            });
                                        },
                                        hasIcon: !1,
                        ...
                        W = {
                            dropdown: Q(
                                ...
                                a.o.plugins.table.backgroundColorList || a.o.plugins.table.colorList,
...
function removeParent(element) {
    element.parentElement.innerHTML = `<button class="btn btn-sm p-0 text-dark-25" onclick="addParent(this)"><i class="la la-plus-circle text-dark-25 p-0"></i> Add Title</button>`;
}
function addParent(element) {
    element.parentElement.innerHTML = `<span onclick="clearDiv(this)" mouseup="placeholderDiv(this)" class="min-w-25px cursor-pointer min-h-20px">Add Title</span> <i class="la la-times text-danger cursor-pointer" onclick="removeParent(this)"></i>`;
} 
function clearDiv(element) {
    element.innerHTML = "";
    element.classList.add('placeholder');
}
function placeholderDiv(element) {
