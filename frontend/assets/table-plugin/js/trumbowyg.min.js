    ...
    (function (e, t, n, a) {
        ...
        var i = function (o, r) {
            ...
            (i.doc = o.ownerDocument || n),
                (i.$ta = a(o)),
                (i.$c = a(o)),
                null != (r = r || {}).lang || null != l.langs[r.lang] ? (i.lang = a.extend(!0, {}, l.langs.en, l.langs[r.lang])) : (i.lang = l.langs.en),
                (i.hideButtonTexts = null != l.hideButtonTexts ? l.hideButtonTexts : r.hideButtonTexts);
            var d = null != l.svgPath ? l.svgPath : r.svgPath;
            if (((i.hasSvg = !1 !== d), !1 !== d && (l.svgAbsoluteUseHref || 0 === a("#" + s, i.doc).length))) {
                if (null == d)
                ...
                if (null == d) console.warn("You must define svgPath: https://goo.gl/CfTY9U");
                    ...
                    (c.id = s),
                        ...
                        a.ajax({
                            ...
                            complete: null,
                            success: function (e) {
                                c.innerHTML = new XMLSerializer().serializeToString(e.documentElement);
                            },
                        });
                }
            }
            var u = i.doc.querySelector("base") ? t.location.href.replace(t.location.hash, "") : "";
            ...
            (i.btnsDef = {
                ...
                i.o.hasOwnProperty("imgDblClickHandler") || (i.o.imgDblClickHandler = i.getDefaultImgDblClickHandler()),
                (i.urlPrefix = i.setupUrlPrefix()),
                (i.disabled = i.o.disabled || ("TEXTAREA" === o.nodeName && o.disabled)),
                r.btns ? (i.o.btns = r.btns) : i.o.semantic || (i.o.btns[3] = ["bold", "italic", "underline", "strikethrough"]),
        ...
        i.prototype = {
            DEFAULT_SEMANTIC_MAP: { b: "strong", i: "em", s: "del", strike: "del", div: "p" },
            init: function () {
                var e = this;
                (e.height = e.$ta.outerHeight() - 39), e.initPlugins();
                try {
            ...
            setupUrlPrefix: function () {
                ...
                if (e) return "string" != typeof e ? "https://" : e.replace("://", "") + "://";
            },
            buildEditor: function () {
                var e = this,
                    n = e.o.prefix,
                    o = "";
                (e.$box = a("<div/>", { class: n + "box " + n + "editor-visible " + n + e.o.lang + " trumbowyg" })),
                    (e.$edBox = a("<div/>", { class: n + "editor-box" })),
                    (e.isTextarea = e.$ta.is("textarea")),
                    e.isTextarea
                        ? ((o = e.$ta.val()), (e.$ed = a("<div/>").appendTo(e.$edBox)), e.$box.insertAfter(e.$ta).append(e.$edBox, e.$ta))
                        : ((e.$ed = e.$ta), (o = e.$ed.html()), (e.$ta = a("<textarea/>", { name: e.$ta.attr("id"), height: e.height }).val(o)), e.$box.insertAfter(e.$ed).append(e.$ta, e.$edBox), e.$edBox.append(e.$ed), e.syncCode()),
                    ...
                    e.$c.is("[spellcheck]") && e.$ed.attr("spellcheck", e.$c.attr("spellcheck")),
                ...
                e.$ed
                    ...
                    .on("keydown", function (t) {
                        var n = t.which;
                        if (((8 !== n && 13 !== n && 46 !== n) || e.toggleSpan(!0), (!t.ctrlKey && !t.metaKey) || t.altKey)) {
                    ...
                    .on("keyup compositionend", function (t) {
                        ...
                        var n = t.which;
                        if (!(n >= 37 && n <= 40)) {
                            if (((8 !== n && 13 !== n && 46 !== n) || e.toggleSpan(), (!t.ctrlKey && !t.metaKey) || (89 !== n && 90 !== n)))
                                if (i || 16 === n || 17 === n) void 0 === t.which && e.semanticCode(!1, !1, !0);
                                else {
                    ...
                    .on("input", function (t) {
                        ...
                        "object" == typeof n && ("insertReplacementText" === n.inputType || ("insertText" === n.inputType && null === n.data)) && e.$c.trigger("tbwchange");
                    })
                    ...
                    .on("focus blur", function (t) {
                        if (("blur" === t.type && e.clearButtonPaneStatus(), e.$c.trigger("tbw" + t.type), e.o.autogrowOnEnter)) {
                            if (e.autogrowOnEnterDontClose) return;
                            "focus" === t.type ? ((e.autogrowOnEnterWasFocused = !0), e.autogrowEditorOnEnter()) : e.o.autogrow || (e.$edBox.css({ height: e.$edBox.css("min-height") }), e.$c.trigger("tbwresize"));
                        }
                    })
                    ...
                    a(e.doc.body).on("keydown." + e.eventNamespace, function (t) {
                        if (27 === t.which && a("." + n + "modal-box").length >= 1) return e.closeModal(), !1;
                    });
            },
            autogrowEditorOnEnter: function () {
                ...
                e.$ed.addClass("autogrow-on-enter"),
                    t !== n &&
                        (e.$edBox.height(t),
                        setTimeout(function () {
                            e.$edBox.css({ height: n }), e.$c.trigger("tbwresize");
                        }, 0));
            },
            ...
            buildBtn: function (e) {
                var t = this,
                    ...
                    l = a("<button/>", {
                        ...
                        title: (o.title || o.text || s) + (o.key ? " (" + (t.isMac ? "Cmd" : "Ctrl") + " + " + o.key + ")" : ""),
                        tabindex: -1,
                        mousedown: function () {
                            return (
                                (r && !a("." + e + "-" + n + "dropdown", t.$box).is(":hidden")) || a("body", t.doc).trigger("mousedown"),
                                !((t.$btnPane.hasClass(n + "disable") || t.$box.hasClass(n + "disabled")) && !a(this).hasClass(n + "active") && !a(this).hasClass(n + "not-disable")) &&
                                    (t.execCmd((!r ? o.fn : "dropdown") || e, o.param || e, o.forceCss), !1)
                            );
                        },
                    });
                if (r) {
            ...
            buildSubBtn: function (e) {
                ...
                return (
                    ...
                    a("<button/>", {
                        type: "button",
                        class: n + e + "-dropdown-button " + (o.class || "") + (o.ico ? " " + n + o.ico + "-button" : ""),
                        html:
                            t.hasSvg && r ? '<svg><use xlink:href="' + t.svgPath + "#" + n + (o.ico || e).replace(/([A-Z]+)/g, "-$1").toLowerCase() + '"/></svg>' + (o.text || o.title || t.lang[e] || e) : o.text || o.title || t.lang[e] || e,
                        title: o.key ? "(" + (t.isMac ? "Cmd" : "Ctrl") + " + " + o.key + ")" : null,
                        style: o.style || null,
                        mousedown: function () {
                    ...
                    a(t).on("scroll." + e.eventNamespace + " resize." + e.eventNamespace, function () {
                        if (o) {
                            ...
                            r - i > 0 && r - i - e.height < 0
                                ? (e.isFixed || ((e.isFixed = !0), s.css({ position: "fixed", top: 0, left: n ? 0 : "auto", zIndex: 7 }), e.$box.css({ paddingTop: s.height() })),
                                  s.css({ width: n ? "100%" : o.width() - 1 }),
                                  a("." + e.o.prefix + "fixed-top", o).css({ position: n ? "fixed" : "absolute", top: n ? l : l + (r - i), zIndex: 15 }))
                                : e.isFixed && ((e.isFixed = !1), s.removeAttr("style"), e.$box.css({ paddingTop: 0 }), a("." + e.o.prefix + "fixed-top", o).css({ position: "absolute", top: l }));
                        }
                    }));
            },
            ...
            toggle: function () {
                var e = this,
                    t = e.o.prefix;
                e.o.autogrowOnEnter && (e.autogrowOnEnterDontClose = !e.$box.hasClass(t + "editor-hidden")),
                    e.semanticCode(!1, !0),
                    e.$c.trigger("tbwchange"),
                    setTimeout(function () {
                        e.doc.activeElement.blur(),
                            ...
                            e.o.autogrowOnEnter && !e.autogrowOnEnterDontClose && e.autogrowEditorOnEnter();
                    }, 0);
            },
            toggleSpan: function (e) {
                this.$ed.find("span").each(function () {
                    !0 === e ? a(this).attr("data-tbw-flag", !0) : a(this).attr("data-tbw-flag") ? a(this).removeAttr("data-tbw-flag") : a(this).contents().unwrap();
                });
            },
            dropdown: function (e) {
                var n = this,
                ...
                if ((o.trigger("mousedown"), l)) {
                    var d = s.offset().left;
                    s.addClass(r + "active"),
                        i.css({ position: "absolute", top: s.offset().top - n.$btnPane.offset().top + s.outerHeight(), left: n.o.fixedFullWidth && n.isFixed ? d : d - n.$btnPane.offset().left }).show(),
                        a(t).trigger("scroll"),
                        o.on("mousedown." + n.eventNamespace, function (e) {
                            i.is(e.target) || (a("." + r + "dropdown", n.$box).hide(), a("." + r + "active", n.$btnPane).removeClass(r + "active"), o.off("mousedown." + n.eventNamespace));
                        });
                }
            },
            html: function (e) {
            ...
            syncCode: function (e) {
                ...
                if ((t.o.autogrow && ((t.height = t.$edBox.height()), t.height !== t.$ta.css("height") && (t.$ta.css({ height: t.height }), t.$c.trigger("tbwresize"))), t.o.autogrowOnEnter)) {
                    t.$edBox.height("auto");
                    var r = t.autogrowOnEnterWasFocused ? t.$edBox[0].scrollHeight : t.$edBox.css("min-height");
                    r !== t.$ta.css("height") && (t.$edBox.css({ height: r }), t.$c.trigger("tbwresize"));
                }
            },
            semanticCode: function (e, t, n) {
                ...
                if ((o.range && o.range.collapsed && (r = !1), o.o.semantic)) {
                    if ((o.semanticTag("b", o.o.semanticKeepAttributes), o.semanticTag("i", o.o.semanticKeepAttributes), o.semanticTag("s", o.o.semanticKeepAttributes), o.semanticTag("strike", o.o.semanticKeepAttributes), t)) {
                        ...
                        l(o.$ed.children(i).first()), o.semanticTag("div", !0), a("[data-tbw]", o.$ed).contents().unwrap(), o.$ed.find("p:empty").remove();
                    }
            ...
            semanticTag: function (e, t, n) {
                var o,
                    r = this,
                    i = e;
                if (null != this.o.semantic && "object" == typeof this.o.semantic && this.o.semantic.hasOwnProperty(e)) o = this.o.semantic[e];
                else {
                    if (!0 !== this.o.semantic || !this.DEFAULT_SEMANTIC_MAP.hasOwnProperty(e)) return;
                ...
                n && ((e = o), (o = i)),
                    a(e, this.$ed).each(function () {
                        ...
                        i.insertBefore(n),
                            ...
                            i.html(n.html()),
                            n.remove(),
                            !0 === e && (r.range.selectNodeContents(i.get(0)), r.range.collapse(!1));
                    });
            },
            createLink: function () {
                for (
                    var e, t, n, o = this, r = o.doc.getSelection(), i = r.getRangeAt(0), s = r.focusNode, l = new XMLSerializer().serializeToString(i.cloneContents()) || i + "", d = o.o.linkTargets[0];
                ...
                if (s && "A" === s.nodeName) {
                    var c = a(s);
                    (l = c.text()), (e = c.attr("href")), o.o.minimalLinks || ((t = c.attr("title")), (n = c.attr("target") || d));
                    var u = o.doc.createRange();
                    u.selectNode(s), r.removeAllRanges(), r.addRange(u);
                }
                o.saveRange();
                var g = { url: { label: o.lang.linkUrl || "URL", required: !0, value: e }, text: { label: o.lang.text, value: l } };
                if (!o.o.minimalLinks) {
                    var f = o.o.linkTargets.reduce(function (e, t) {
                        return (e[t] = o.lang[t]), e;
                    }, {});
                    a.extend(g, { title: { label: o.lang.title, value: t }, target: { label: o.lang.target, value: n, options: f } });
                }
                o.openModalInsert(o.lang.createLink, g, function (e) {
                    var t = o.prependUrlPrefix(e.url);
                    if (!t.length) return !1;
                    var n = a(['<a href="', t, '">', e.text || e.url, "</a>"].join(""));
                    return e.title && n.attr("title", e.title), (e.target || d) && n.attr("target", e.target || d), o.range.deleteContents(), o.range.insertNode(n[0]), o.syncCode(), o.$c.trigger("tbwchange"), !0;
                });
            },
            prependUrlPrefix: function (e) {
                if (!this.urlPrefix) return e;
                if (/^([a-z][-+.a-z0-9]*:|\/|#)/i.test(e)) return e;
                return /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e) ? "mailto:" + e : this.urlPrefix + e;
            },
            unlink: function () {
                var e = this,
            ...
            fullscreen: function () {
                var e,
                    ...
                    s = n.$box.outerHeight();
                n.$box.toggleClass(r),
                    (e = n.$box.hasClass(r)) ? n.$box.before(a("<div/>", { class: i }).css({ height: s })) : a("." + i).remove(),
            ...
            execCmd: function (e, n, o, r) {
                var i = this;
                (r = !!r || ""), "dropdown" !== e && i.$ed.focus(), "strikethrough" === e && i.o.semantic && i.semanticTag("strike", i.o.semanticKeepAttributes, !0);
                try {
                ...
                try {
                    ...
                    try {
                        ...
                        "insertHorizontalRule" === e ? (n = void 0) : "formatBlock" === e && i.isIE && (n = "<" + n + ">"), i.doc.execCommand(e, !1, n), i.syncCode(), i.semanticCode(!1, !0);
                        try {
                            var s = t.getSelection().focusNode;
                            a(t.getSelection().focusNode.parentNode).hasClass("trumbowyg-editor") || (s = t.getSelection().focusNode.parentNode);
                            var l = i.o.tagClasses[n];
                            l && a(s).addClass(l);
                        } catch (e) {}
                    }
                    "dropdown" !== e && (i.updateButtonPaneStatus(), i.$c.trigger("tbwchange"));
                }
            },
            openModal: function (e, n, i) {
                var s = this,
                    l = s.o.prefix;
                if (((i = !1 !== i), a("." + l + "modal-box", s.$box).length > 0)) return !1;
                s.o.autogrowOnEnter && (s.autogrowOnEnterDontClose = !0), s.saveRange(), s.showOverlay(), s.$btnPane.addClass(l + "disable");
                var d,
                    c = a("<div/>", { class: l + "modal " + l + "fixed-top" })
                        .css({ top: s.$box.offset().top + s.$btnPane.height(), zIndex: 99999 })
                        .appendTo(a(s.doc.body)),
                    u = l + "dark";
                0 !== s.$c.parents("." + u).length && c.addClass(u),
                    ...
                    (d = i
                        ...
                        : n);
                var g = a("<div/>", { class: l + "modal-box", html: d })
                    .css({ top: "-" + s.$btnPane.outerHeight(), opacity: 0, paddingBottom: i ? null : "5%" })
                    .appendTo(c)
                    .animate({ top: 0, opacity: 1 }, 100);
                return (
                    e && a("<span/>", { text: e, class: l + "modal-title" }).prependTo(g),
                    i && (a(":input:first", g).focus(), s.buildModalBtn("submit", g), s.buildModalBtn("reset", g), c.height(g.outerHeight() + 10)),
                    a(t).trigger("scroll"),
            ...
            buildModalBtn: function (e, t) {
                var n = this.o.prefix;
                return a("<button/>", { class: n + "modal-button " + n + "modal-" + e, type: e, text: this.lang[e] || e }).appendTo(a("form", t));
            },
            closeModal: function () {
                var e = this,
                    t = e.o.prefix;
                    ...
                    a.each(t, function (e, t) {
                        var n = t.label || e,
                            ...
                            u = Object.keys(r)
                                ...
                                .join(" ");
                        if ("function" == typeof t.type) return t.name || (t.name = o), void (d += t.type(t, i, s, l));
                        (d += '<div class="' + s + 'input-row">'),
                            (d += '<div class="' + s + 'input-infos"><label for="' + i + '"><span>' + (l[n] ? l[n] : n) + "</span></label></div>"),
                            (d += '<div class="' + s + 'input-html">'),
                            a.isPlainObject(t.options)
                                ? ((d += '<select name="target">'),
                                  (d += Object.keys(t.options)
                                      .map((e) => '<option value="' + e + '" ' + (e === t.value ? "selected" : "") + ">" + t.options[e] + "</option>")
                                      .join("")),
                                  (d += "</select>"))
                                : ((d += '<input id="' + i + '" type="' + (t.type || "text") + '" name="' + o + '" ' + u),
                                  (d += ("checkbox" === t.type && t.value ? ' checked="checked"' : "") + ' value="' + (t.value || "").replace(/"/g, "&quot;") + '">')),
                            (d += "</div></div>");
                    }),
                    i
                        .openModal(e, d)
            ...
            getDefaultImgDblClickHandler: function () {
                ...
                return function () {
                    ...
                    var r = { url: { label: "URL", value: n, required: !0 }, alt: { label: e.lang.description, value: t.attr("alt") } };
                    return (
                        e.o.imageWidthModalEdit && (r.width = { value: t.attr("width") ? t.attr("width") : "" }),
            ...
            saveRange: function () {
                ...
                if (((e.range = null), t && t.rangeCount)) {
                    var n,
                        ...
                        o = e.doc.createRange();
                    o.selectNodeContents(e.$ed[0]), o.setEnd(a.startContainer, a.startOffset), (n = (o + "").length), (e.metaRange = { start: n, end: n + (a + "").length });
                }
            },
            ...
            updateButtonPaneStatus: function () {
                var e = this,
                    ...
                    n = t + "active-button " + t + "active",
                    o = t + "original-icon",
                    r = e.getTagsRecursive(e.doc.getSelection().anchorNode);
                e.clearButtonPaneStatus(),
                    a.each(r, function (r, i) {
                        ...
                        if (l.length > 0) l.addClass(n);
                            ...
                            try {
                                var d = (l = a("." + t + "dropdown ." + t + s + "-dropdown-button", e.$box)).find("svg use"),
                                    c = l.parent().data(t + "dropdown"),
                                    u = a("." + t + c + "-button", e.$box),
                                    g = u.find("svg use");
                                u.addClass(n), e.o.changeActiveDropdownIcon && d.length > 0 && (u.addClass(o).data(o, g.attr("xlink:href")), g.attr("xlink:href", d.attr("xlink:href")));
                            } catch (e) {}
                    });
            },
            getTagsRecursive: function (e, t) {
                ...
                return "DIV" === o
                    ...
                    : ("P" === o && "" !== e.style.textAlign && t.push(e.style.textAlign),
                      ...
                      t.push(o),
                      n.getTagsRecursive(e.parentNode, t).filter(function (e) {
                          return null != e;
                      }));
            },
