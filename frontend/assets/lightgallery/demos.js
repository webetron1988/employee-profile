        ...
        document.getElementById('dynamic').addEventListener('click', function() {
            ...
            lightGallery(document.getElementById('dynamic'), {
                ...
                dynamicEl: [
                    ...
                    {
                      video: { "source": [{ "src": "https://static.videezy.com/system/resources/previews/000/007/291/original/Dunes.mp4", "type": "video/mp4" }], "attributes": { "preload": false, "controls": true } },
                      thumb:
