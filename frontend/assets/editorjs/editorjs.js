 ...
 * Original file: /npm/@editorjs/editorjs@2.30.5/dist/editorjs.umd.js
 *
...
(function (ge, ee) {
    typeof exports == "object" && typeof module < "u" ? (module.exports = ee()) : typeof define == "function" && define.amd ? define(ee) : ((ge = typeof globalThis < "u" ? globalThis : ge || self), (ge.EditorJS = ee()));
})(this, function () {
    "use strict";
    ...
    function ze() {}
    Object.assign(ze, { default: ze, register: ze, revert: function () {}, __esModule: !0 }),
        ...
        Element.prototype.scrollIntoViewIfNeeded ||
            (Element.prototype.scrollIntoViewIfNeeded = function (n) {
                ...
                const e = this.parentNode,
                    ...
                    a = this.offsetLeft - e.offsetLeft + this.clientWidth - i > e.scrollLeft + e.clientWidth,
                    c = s && !r;
                (s || r) && n && (e.scrollTop = this.offsetTop - e.offsetTop - e.clientHeight / 2 - o + this.clientHeight / 2),
                    (l || a) && n && (e.scrollLeft = this.offsetLeft - e.offsetLeft - e.clientWidth / 2 - i + this.clientWidth / 2),
                    (s || r || l || a) && !n && this.scrollIntoView(c);
            }),
    ...
    let bo = (n = 21) => crypto.getRandomValues(new Uint8Array(n)).reduce((e, t) => ((t &= 63), t < 36 ? (e += t.toString(36)) : t < 62 ? (e += (t - 26).toString(36).toUpperCase()) : t > 62 ? (e += "-") : (e += "_"), e), "");
    var mt = ((n) => ((n.VERBOSE = "VERBOSE"), (n.INFO = "INFO"), (n.WARN = "WARN"), (n.ERROR = "ERROR"), n))(mt || {});
    const w = { BACKSPACE: 8, TAB: 9, ENTER: 13, SHIFT: 16, CTRL: 17, ALT: 18, ESC: 27, SPACE: 32, LEFT: 37, UP: 38, DOWN: 40, RIGHT: 39, DELETE: 46, META: 91, SLASH: 191 },
        ko = { LEFT: 0, WHEEL: 1, RIGHT: 2, BACKWARD: 3, FORWARD: 4 };
    function me(n, e, t = "log", o, i = "color: inherit") {
    ...
    function O(n) {
        return ie(n) === "function" || ie(n) === "asyncfunction";
    }
    function P(n) {
        return ie(n) === "object";
    }
    ...
    function je(n, ...e) {
        ...
        const t = e.shift();
        if (P(n) && P(t)) for (const o in t) P(t[o]) ? (n[o] || Object.assign(n, { [o]: {} }), je(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
        return je(n, ...e);
    }
    function $e(n) {
        const e = Bo();
        return (
            (n = n
                ...
                .replace(/delete/gi, "␡")
                .replace(/\+/gi, " + ")),
            e.mac ? (n = n.replace(/ctrl|cmd/gi, "⌘").replace(/alt/gi, "⌥")) : (n = n.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN")),
            n
        );
    }
    function To(n) {
    ...
    function Mo(n, e) {
        const t = Array.isArray(n) || P(n),
            o = Array.isArray(e) || P(e);
    ...
    class d {
        ...
        static findAllInputs(e) {
            return wt(e.querySelectorAll(d.allInputsSelector)).reduce((t, o) => (d.isNativeInput(o) || d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...d.getDeepestBlockElements(o)]), []);
        }
        ...
        static isNodeEmpty(e, t) {
            ...
            return this.isSingleTag(e) && !this.isLineBreakTag(e)
                ? !1
                : (this.isElement(e) && this.isNativeInput(e) ? (o = e.value) : (o = e.textContent.replace("​", "")), t && (o = o.replace(new RegExp(t, "g"), "")), o.trim().length === 0);
        }
        static isLeaf(e) {
    ...
    const Bt = {
            ...
            tools: { link: { "Add a link": "" }, stub: { "The block can not be displayed correctly.": "" } },
            blockTunes: { delete: { Delete: "", "Click to delete": "" }, moveUp: { "Move up": "" }, moveDown: { "Move down": "" } },
        },
        Tt = class fe {
            static ui(e, t) {
                return fe._t(e, t);
            ...
            static setDictionary(e) {
                fe.currentDictionary = e;
            }
            static _t(e, t) {
                const o = fe.getNamespace(e);
                return !o || !o[t] ? t : o[t];
            }
            static getNamespace(e) {
                return e.split(".").reduce((o, i) => (!o || !Object.keys(o).length ? {} : o[i]), fe.currentDictionary);
            }
        };
    Tt.currentDictionary = Bt;
    let H = Tt;
    ...
    class b {
        ...
        static get rect() {
            ...
            if (!window.getSelection) return C("Method window.getSelection is not supported", "warn"), o;
            if (((e = window.getSelection()), e.rangeCount === null || isNaN(e.rangeCount))) return C("Method SelectionUtils.rangeCount is not supported", "warn"), o;
        ...
        static setCursor(e, t = 0) {
            ...
            return d.isNativeInput(e)
                ? d.canSetCaret(e)
                    ? (e.focus(), (e.selectionStart = e.selectionEnd = t), e.getBoundingClientRect())
                    : void 0
                : (o.setStart(e, t), o.setEnd(e, t), i.removeAllRanges(), i.addRange(o), o.getBoundingClientRect());
        }
        ...
        findParentTag(e, t, o = 10) {
            ...
            return !i || !i.anchorNode || !i.focusNode
                ? null
                : ([i.anchorNode, i.focusNode].forEach((l) => {
                      let a = o;
                      for (; a > 0 && l.parentNode && !(l.tagName === e && ((s = l), t && l.classList && !l.classList.contains(t) && (s = null), s)); ) (l = l.parentNode), a--;
                  }),
                  s);
        }
        expandToTag(e) {
    ...
    const Ke = "redactor dom changed",
        St = "block changed",
        It = "fake cursor is about to be toggled",
        Mt = "fake cursor have been set",
        ve = "editor mobile layout toggled";
    function At(n, e) {
    ...
    function Ot(n, e) {
        return Object.entries(n).some(([t, o]) => e[t] && Mo(e[t], o));
    }
    async function Lt(n, e) {
        const o = (await n.save()).data;
        return e.reduce((i, s) => {
            if (!At(s, "import")) return i;
            const r = s.toolbox.filter((l) => {
                if (V(l) || !l.icon) return !1;
                if (l.data !== void 0) {
                    if (Ot(l.data, o)) return !1;
                } else if (s.name === n.name) return !1;
                return !0;
            });
            return i.push({ ...s, toolbox: r }), i;
        }, []);
    }
    function _t(n, e) {
        return n.mergeable ? (n.name === e.name ? !0 : Oe(e, "export") && Oe(n, "import")) : !1;
    }
    function _o(n, e) {
        const t = e == null ? void 0 : e.export;
        return O(t) ? t(n) : G(t) ? n[t] : (t !== void 0 && C("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
    }
    function Nt(n, e) {
    ...
    var A = ((n) => ((n.Default = "default"), (n.Separator = "separator"), (n.Html = "html"), n))(A || {}),
        Q = ((n) => ((n.APPEND_CALLBACK = "appendCallback"), (n.RENDERED = "rendered"), (n.MOVED = "moved"), (n.UPDATED = "updated"), (n.REMOVED = "removed"), (n.ON_PASTE = "onPaste"), n))(Q || {});
    class D extends be {
        constructor({ id: e = Co(), data: t, tool: o, readOnly: i, tunesData: s }, r) {
            super(),
                (this.cachedInputs = []),
                    ...
                    a || c
                        ...
                        : (u = !(
                              ...
                              l.every((p) => {
                                  ...
                                  return [...Array.from(g), ...Array.from(f), k].some((I) => (d.isElement(I) || (I = I.parentElement), I && I.closest('[data-mutation-free="true"]') !== null));
                              })
                          )),
        ...
        static get CSS() {
            return { wrapper: "ce-block", wrapperStretched: "ce-block--stretched", content: "ce-block__content", selected: "ce-block--selected", dropTarget: "ce-block--drop-target" };
        }
        get inputs() {
        ...
        set selected(e) {
            ...
            (t || o) && ((i = this.editorEventBus) == null || i.emit(It, { state: e }), t ? b.addFakeCursor() : b.removeFakeCursor(this.holder), (s = this.editorEventBus) == null || s.emit(Mt, { state: e }));
        }
        get selected() {
        ...
        call(e, t) {
            if (O(this.toolInstance[e])) {
                e === "appendCallback" && C("`appendCallback` hook is deprecated and will be removed in the next major release. Use `rendered` hook instead", "warn");
                try {
            ...
            [...this.tunesInstances.entries(), ...this.defaultTunesInstances.entries()].forEach(([s, r]) => {
                if (O(r.save))
                    try {
                        ...
                        C(`Tune ${r.constructor.name} save method throws an Error %o`, "warn", l);
                    }
            });
            const o = window.performance.now();
            let i;
            return Promise.resolve(e)
                .then((s) => ((i = window.performance.now()), { id: this.id, tool: this.name, data: s, tunes: t, time: i - o }))
                .catch((s) => {
        ...
        getTunes() {
            ...
            return (
                d.isElement(o) ? e.push({ type: A.Html, element: o }) : Array.isArray(o) ? e.push(...o) : e.push(o),
                [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()]
                    .map((s) => s.render())
                    .forEach((s) => {
                        d.isElement(s) ? t.push({ type: A.Html, element: s }) : Array.isArray(s) ? t.push(...s) : t.push(s);
                    }),
        ...
        async getActiveToolboxEntry() {
            ...
            const t = await this.data,
                o = e;
            return o == null ? void 0 : o.find((i) => Ot(i.data, t));
        }
        async exportDataAsString() {
            const e = await this.data;
            return _o(e, this.tool.conversionConfig);
        }
        compose() {
            const e = d.make("div", D.CSS.wrapper),
                t = d.make("div", D.CSS.content),
                o = this.toolInstance.render();
            (e.dataset.id = this.id), (this.toolRenderedElement = o), t.appendChild(this.toolRenderedElement);
            let i = t;
            return (
                [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()].forEach((s) => {
                    if (O(s.wrap))
                        try {
                            i = s.wrap(i);
                        } catch (r) {
                            C(`Tune ${s.constructor.name} wrap method throws an Error %o`, "warn", r);
                        }
                }),
                e.appendChild(i),
                e
        ...
        watchBlockMutations() {
            ...
            (this.redactorDomChangedCallback = (t) => {
                const { mutations: o } = t;
                o.some((s) => Lo(s, this.toolRenderedElement)) && this.didMutated(o);
            }),
        ...
        toggleInputsEmptyMark() {
            this.inputs.forEach(Et);
        }
    }
    class No extends y {
        constructor() {
            super(...arguments),
                (this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, l) => {
                    const a = this.Editor.BlockManager.insert({ id: l, tool: e, data: t, index: i, needToFocus: s, replace: r });
                    return new J(a);
                }),
                (this.composeBlockData = async (e) => {
                    const t = this.Editor.Tools.blockTools.get(e);
                    return new D({ tool: t, api: this.Editor.API, readOnly: !0, data: {}, tunesData: {} }).data;
                }),
                ...
                (this.convert = async (e, t, o) => {
                    ...
                    const l = s.blockTools.get(r.name),
                        a = s.blockTools.get(t);
                    if (!a) throw new Error(`Block Tool with type "${t}" not found`);
                    const c = ((h = l == null ? void 0 : l.conversionConfig) == null ? void 0 : h.export) !== void 0,
                        u = ((p = a.conversionConfig) == null ? void 0 : p.import) !== void 0;
                    if (c && u) {
                        const g = await i.convert(r, t, o);
                        return new J(g);
                    } else {
                        const g = [c ? !1 : Ae(r.name), u ? !1 : Ae(t)].filter(Boolean).join(" and ");
                        throw new Error(`Conversion from "${r.name}" to "${t}" is not possible. ${g} tool(s) should provide a "conversionConfig"`);
                    }
                }),
                (this.insertMany = (e, t = this.Editor.BlockManager.blocks.length - 1) => {
                    this.validateIndex(t);
                    const o = e.map(({ id: i, type: s, data: r }) => this.Editor.BlockManager.composeBlock({ id: i, tool: s || this.config.defaultBlock, data: r }));
        ...
        swap(e, t) {
            C("`blocks.swap()` method is deprecated and will be removed in the next major release. Use `block.move()` method instead", "info"), this.Editor.BlockManager.swap(e, t);
        }
        move(e, t) {
        ...
        stretchBlock(e, t = !0) {
            Ye(!0, "blocks.stretchBlock()", "BlockAPI");
    ...
    class Do extends y {
        constructor() {
            super(...arguments),
                (this.setToFirstBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) => (this.Editor.BlockManager.firstBlock ? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.firstBlock, e, t), !0) : !1)),
                (this.setToLastBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) => (this.Editor.BlockManager.lastBlock ? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.lastBlock, e, t), !0) : !1)),
                (this.setToPreviousBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) => (this.Editor.BlockManager.previousBlock ? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.previousBlock, e, t), !0) : !1)),
                (this.setToNextBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) => (this.Editor.BlockManager.nextBlock ? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.nextBlock, e, t), !0) : !1)),
                (this.setToBlock = (e, t = this.Editor.Caret.positions.DEFAULT, o = 0) => {
                    const i = Po(e, this.Editor);
    ...
    class Ro extends y {
        get methods() {
            return { emit: (e, t) => this.emit(e, t), off: (e, t) => this.off(e, t), on: (e, t) => this.on(e, t) };
        }
        on(e, t) {
    ...
    class Xe extends y {
        ...
        getMethodsForTool(e, t) {
            return Object.assign(this.methods, { t: (o) => H.t(Xe.getNamespace(e, t), o) });
        }
    }
    class Fo extends y {
        get methods() {
    ...
    class zo extends y {
        get methods() {
            return { on: (e, t, o, i) => this.on(e, t, o, i), off: (e, t, o, i) => this.off(e, t, o, i), offById: (e) => this.offById(e) };
        }
        on(e, t, o, i) {
                ...
                function (t, o, i) {
                    ...
                    function f(v, m) {
                        for (var x = 0; x < v.length; x++) {
                            ...
                            if (M) {
                                M.refs++;
                                for (var T = 0; T < M.parts.length; T++) M.parts[T](E.parts[T]);
                                for (; T < E.parts.length; T++) M.parts.push(j(E.parts[T], m));
                            } else {
                                var R = [];
                                for (T = 0; T < E.parts.length; T++) R.push(j(E.parts[T], m));
                    ...
                    function k(v, m) {
                        for (var x = [], E = {}, M = 0; M < v.length; M++) {
                            var T = v[M],
                                R = m.base ? T[0] + m.base : T[0],
                                B = { css: T[1], media: T[2], sourceMap: T[3] };
                            E[R] ? E[R].parts.push(B) : x.push((E[R] = { id: R, parts: [B] }));
                        }
                        return x;
                    }
                    function S(v, m) {
                        ...
                        var E = p[p.length - 1];
                        if (v.insertAt === "top") E ? (E.nextSibling ? x.insertBefore(m, E.nextSibling) : x.appendChild(m)) : x.insertBefore(m, x.firstChild), p.push(m);
                        else if (v.insertAt === "bottom") x.appendChild(m);
                        else {
...
`);
                    ...
                    function N(v) {
                        ...
                        return v.attrs.type === void 0 && (v.attrs.type = "text/css"), oe(m, v.attrs), S(v, m), m;
                    }
                    function oe(v, m) {
                    ...
                    function j(v, m) {
                        ...
                        if (m.transform && v.css) {
                            if (!(T = m.transform(v.css))) return function () {};
                            v.css = T;
                        }
                        if (m.singleton) {
                            var R = h++;
                            (x = u || (u = N(m))), (E = Te.bind(null, x, R, !1)), (M = Te.bind(null, x, R, !0));
                        } else
                            v.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function"
                                ? ((x = (function (B) {
                                      var K = document.createElement("link");
                                      return B.attrs.type === void 0 && (B.attrs.type = "text/css"), (B.attrs.rel = "stylesheet"), oe(K, B.attrs), S(B, K), K;
                                  })(m)),
                                  (E = function (B, K, Ce) {
                                      var ae = Ce.css,
                                          gt = Ce.sourceMap,
                                          ws = K.convertToAbsoluteUrls === void 0 && gt;
                                      (K.convertToAbsoluteUrls || ws) && (ae = g(ae)),
                                          gt &&
                                              (ae +=
                                                  `
/*# sourceMappingURL=data:application/json;base64,` +
                                                  btoa(unescape(encodeURIComponent(JSON.stringify(gt)))) +
                                                  " */");
                                      var xs = new Blob([ae], { type: "text/css" }),
                                          po = B.href;
                                      (B.href = URL.createObjectURL(xs)), po && URL.revokeObjectURL(po);
                                  }.bind(null, x, m)),
                                  (M = function () {
                                      I(x), x.href && URL.revokeObjectURL(x.href);
                                  }))
                                : ((x = N(m)),
                                  (E = function (B, K) {
                                      var Ce = K.css,
                                          ae = K.media;
                                      if ((ae && B.setAttribute("media", ae), B.styleSheet)) B.styleSheet.cssText = Ce;
                                      else {
                    ...
                    t.exports = function (v, m) {
                        ...
                        ((m = m || {}).attrs = typeof m.attrs == "object" ? m.attrs : {}),
                            m.singleton || typeof m.singleton == "boolean" || (m.singleton = a()),
...
`)
                    ...
                    function Te(v, m, x, E) {
                        var M = x ? "" : E.css;
                        if (v.styleSheet) v.styleSheet.cssText = le(m, M);
                        else {
                            var T = document.createTextNode(M),
                                R = v.childNodes;
                            R[m] && v.removeChild(R[m]), R.length ? v.insertBefore(T, R[m]) : v.appendChild(T);
                        }
                    }
                },
                function (t, o) {
                        ...
                        (p = "cdx-notify__btns-wrapper"),
                        {
                            alert: (g = function (f) {
                                var k = document.createElement("DIV"),
                                    ...
                                    I = f.message,
                                    N = f.style;
                                return k.classList.add(r), N && k.classList.add(r + "--" + N), (k.innerHTML = I), S.classList.add(l), S.addEventListener("click", k.remove.bind(k)), k.appendChild(S), k;
                            }),
                            confirm: function (f) {
                                var k = g(f),
                                    S = document.createElement("div"),
                                    ...
                                    oe = k.querySelector("." + l),
                                    j = f.cancelHandler,
                                    W = f.okHandler;
                                return (
                                    S.classList.add(p),
                                    (I.innerHTML = f.okText || "Confirm"),
                                    (N.innerHTML = f.cancelText || "Cancel"),
                                    I.classList.add(h),
                                    N.classList.add(h),
                                    I.classList.add(a),
                                    N.classList.add(c),
                                    j && typeof j == "function" && (N.addEventListener("click", j), oe.addEventListener("click", j)),
                                    W && typeof W == "function" && I.addEventListener("click", W),
                                    I.addEventListener("click", k.remove.bind(k)),
                                    N.addEventListener("click", k.remove.bind(k)),
                                    S.appendChild(I),
                                    S.appendChild(N),
                                    k.appendChild(S),
                                    k
                            ...
                            prompt: function (f) {
                                ...
                                return (
                                    S.classList.add(p),
                                    (I.innerHTML = f.okText || "Ok"),
                                    I.classList.add(h),
                                    I.classList.add(a),
                                    N.classList.add(u),
                                    f.placeholder && N.setAttribute("placeholder", f.placeholder),
                                    f.default && (N.value = f.default),
                                    f.inputType && (N.type = f.inputType),
                                    j && typeof j == "function" && oe.addEventListener("click", j),
                                    W &&
                                        typeof W == "function" &&
    ...
    class Yo extends y {
        constructor({ config: e, eventsDispatcher: t }) {
            super({ config: e, eventsDispatcher: t }), (this.notifier = new $o());
        }
        get methods() {
                ...
                (t.prototype._sanitize = function (h, p) {
                    ...
                    if (f)
                        do {
                            ...
                            var k = r(f),
                                S;
                            k && (S = Array.prototype.some.call(f.childNodes, i));
                            var I = !!p.parentNode,
                                N = i(p) && i(f) && I,
                                oe = f.nodeName.toLowerCase(),
                                j = a(this.config, oe, f),
                                W = k && S;
                            if (W || c(f, j) || (!this.config.keepNestedBlockElements && N)) {
                                if (!(f.nodeName === "SCRIPT" || f.nodeName === "STYLE")) for (; f.childNodes.length > 0; ) p.insertBefore(f.childNodes[0], f);
                                p.removeChild(f), this._sanitize(h, p);
                                break;
                            }
                            for (var le = 0; le < f.attributes.length; le += 1) {
                                var Te = f.attributes[le];
                                u(Te, j, f) && (f.removeAttribute(Te.name), (le = le - 1));
                            }
                            this._sanitize(h, f);
    ...
    function Ve(n, e) {
        return n.map((t) => {
            ...
            return V(o) || (t.data = qe(t.data, o)), t;
        });
    }
    function q(n, e = {}) {
        const t = { tags: e };
        return new Xo(t).clean(n);
    }
    function qe(n, e) {
        return Array.isArray(n) ? Vo(n, e) : P(n) ? qo(n, e) : G(n) ? Zo(n, e) : n;
    }
    function Vo(n, e) {
        return n.map((t) => qe(t, e));
    }
    function qo(n, e) {
        const t = {};
        for (const o in n) {
    ...
    class ii extends y {
        get methods() {
            return { close: () => this.close(), open: () => this.open(), toggleBlockSettings: (e) => this.toggleBlockSettings(e), toggleToolbox: (e) => this.toggleToolbox(e) };
        }
        open() {
                    ...
                    class s {
                        constructor() {
                            (this.nodes = { wrapper: null, content: null }),
                                ...
                                this.loadStyles(),
                                this.prepare(),
                                window.addEventListener("scroll", this.handleWindowScroll, { passive: !0 });
                        }
                        get CSS() {
                        ...
                        show(l, a, c) {
                            ...
                            if ((u.hidingDelay && (this.hidingDelay = u.hidingDelay), (this.nodes.content.innerHTML = ""), typeof a == "string")) this.nodes.content.appendChild(document.createTextNode(a));
                            else {
                                if (!(a instanceof Node)) throw Error("[CodeX Tooltip] Wrong type of «content» passed. It should be an instance of Node or String. But " + typeof a + " given.");
                        ...
                        loadStyles() {
                            ...
                            const a = i(2),
                                c = this.make("style", null, { textContent: a.toString(), id: l });
                            this.prepend(document.head, c);
                        }
                        placeBottom(l, a) {
                            const c = l.getBoundingClientRect(),
                                u = c.left + l.clientWidth / 2 - this.nodes.wrapper.offsetWidth / 2,
                                h = c.bottom + window.pageYOffset + this.offsetTop + a.marginTop;
                        ...
                        placeLeft(l, a) {
                            const c = l.getBoundingClientRect(),
                                u = c.left - this.nodes.wrapper.offsetWidth - this.offsetLeft - a.marginLeft,
                                h = c.top + window.pageYOffset + l.clientHeight / 2 - this.nodes.wrapper.offsetHeight / 2;
                            this.applyPlacement("left", u, h);
                        }
                        placeRight(l, a) {
                            const c = l.getBoundingClientRect(),
                                u = c.right + this.offsetRight + a.marginRight,
                                h = c.top + window.pageYOffset + l.clientHeight / 2 - this.nodes.wrapper.offsetHeight / 2;
    ...
    function ri(n, e, t) {
        Ze(), z == null || z.show(n, e, t);
    }
    function Le(n = !1) {
        Ze(), z == null || z.hide(n);
    }
    function _e(n, e, t) {
        Ze(), z == null || z.onHover(n, e, t);
    }
    function li() {
    ...
    class ai extends y {
        ...
        get methods() {
            return { show: (e, t, o) => this.show(e, t, o), hide: () => this.hide(), onHover: (e, t, o) => this.onHover(e, t, o) };
        }
        show(e, t, o) {
            ri(e, t, o);
        }
    ...
    function Ft(n, e) {
        ...
        return (
            Object.entries(n).forEach(([o, i]) => {
                if (P(i)) {
                    const s = e ? `${e}.${o}` : o;
                    Object.values(i).every((l) => G(l)) ? (t[o] = s) : (t[o] = Ft(i, s));
                    return;
                }
                t[o] = i;
            }),
    ...
    const Ht = class Se {
        ...
        next() {
            this.cursor = this.leafNodesAndReturnIndex(Se.directions.RIGHT);
        }
        previous() {
            this.cursor = this.leafNodesAndReturnIndex(Se.directions.LEFT);
        }
        dropCursor() {
        ...
        leafNodesAndReturnIndex(e) {
            ...
            let t = this.cursor;
            return (
                t === -1 ? (t = e === Se.directions.RIGHT ? -1 : 0) : this.items[t].classList.remove(this.focusedCssClass),
                e === Se.directions.RIGHT ? (t = (t + 1) % this.items.length) : (t = (this.items.length + t - 1) % this.items.length),
                d.canSetCaret(this.items[t]) && Me(() => b.setCursor(this.items[t]), 50)(),
                this.items[t].classList.add(this.focusedCssClass),
                t
            );
        }
    };
    Ht.directions = { RIGHT: "right", LEFT: "left" };
    let we = Ht;
    class se {
        constructor(e) {
            (this.iterator = null),
                ...
                (this.iterator = new we(e.items, e.focusedItemClass)),
                (this.activateCallback = e.activateCallback),
                (this.allowedKeys = e.allowedKeys || se.usedKeys);
        }
        get isActivated() {
            return this.activated;
        }
        static get usedKeys() {
            return [w.TAB, w.LEFT, w.RIGHT, w.ENTER, w.UP, w.DOWN];
        }
        activate(e, t) {
        ...
        handleTabPress(e) {
            switch (e.shiftKey ? we.directions.LEFT : we.directions.RIGHT) {
    ...
    const hi =
            '<img src="assets/media/images/strategy-editorjs-bold.svg" class="h-15">',
        ui =
        // down angle
        ...
        // left angle
            ...
            '<i class="la la-angle-right text-dark mb-1"></i>',
        gi =
        // top arrow
            ...
            // times 
        mi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>',
        // O icon
        bi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>',
        ki =
            '<img src="assets/media/images/strategy-editorjs-italic.svg" class="h-15">',
        zt =
            '<img src="assets/media/images/strategy-editorjs-link.svg" class="h-15">',
        vi =
        // Drag icon
            ...
            // plus icon
        wi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>',
        Ut =
        // cross arrows
        ...
        Ti = "--";
    function te(n) {
        return (e, t) => [[n, e].filter((i) => !!i).join(Bi), t].filter((i) => !!i).join(Ti);
    }
    const xe = te("ce-hint"),
        ye = { root: xe(), alignedStart: xe(null, "align-left"), alignedCenter: xe(null, "align-center"), title: xe("title"), description: xe("description") },
        Cs = "";
    class Ci {
        constructor(e) {
            (this.nodes = { root: d.make("div", [ye.root, e.alignment === "center" ? ye.alignedCenter : ye.alignedStart]), title: d.make("div", ye.title, { textContent: e.title }) }),
                this.nodes.root.appendChild(this.nodes.title),
                e.description !== void 0 && ((this.nodes.description = d.make("div", ye.description, { textContent: e.description })), this.nodes.root.appendChild(this.nodes.description));
        }
        getElement() {
    ...
    class Ge {
        ...
        addHint(e, t) {
            const o = new Ci(t);
            _e(e, o.getElement(), { placement: t.position, hidingDelay: 100 });
        }
        get children() {
            var e;
    ...
    class ne extends Ge {
        ...
        make(e, t) {
            ...
            const o = (t == null ? void 0 : t.wrapperTag) || "div",
                i = d.make(o, L.container, { type: o === "button" ? "button" : void 0 });
            return (
                e.name && (i.dataset.itemName = e.name),
                (this.nodes.icon = d.make("div", [L.icon, L.iconTool], { innerHTML: e.icon || bi })),
                i.appendChild(this.nodes.icon),
                e.title !== void 0 && i.appendChild(d.make("div", L.title, { innerHTML: e.title || "" })),
                e.secondaryLabel && i.appendChild(d.make("div", L.secondaryTitle, { textContent: e.secondaryLabel })),
                this.hasChildren && i.appendChild(d.make("div", [L.icon, L.iconChevronRight], { innerHTML: fi })),
                this.isActive && i.classList.add(L.active),
                e.isDisabled && i.classList.add(L.disabled),
                e.hint !== void 0 && ((s = t == null ? void 0 : t.hint) == null ? void 0 : s.enabled) !== !1 && this.addHint(i, { ...e.hint, position: ((r = t == null ? void 0 : t.hint) == null ? void 0 : r.position) || "right" }),
                i
            );
        }
        enableConfirmationMode(e) {
            if (this.nodes.root === null) return;
            const t = { ...this.params, ...e, confirmation: "confirmation" in e ? e.confirmation : void 0 },
                o = this.make(t);
        ...
        enableSpecialHoverAndFocusBehavior() {
            ...
            (e = this.nodes.root) == null || e.classList.add(L.noHover),
                ...
                (o = this.nodes.root) == null || o.addEventListener("mouseleave", this.removeSpecialHoverBehavior, { once: !0 });
        }
        ...
        animateError() {
            var e, t, o;
            ((e = this.nodes.icon) != null && e.classList.contains(L.wobbleAnimation)) ||
                ((t = this.nodes.icon) == null || t.classList.add(L.wobbleAnimation), (o = this.nodes.icon) == null || o.addEventListener("animationend", this.onErrorAnimationEnd));
        }
    }
    const Je = te("ce-popover-item-separator"),
        Qe = { container: Je(), line: Je("line"), hidden: Je(null, "hidden") };
    class jt extends Ge {
        constructor() {
            super(), (this.nodes = { root: d.make("div", Qe.container), line: d.make("div", Qe.line) }), this.nodes.root.appendChild(this.nodes.line);
        }
        getElement() {
            return this.nodes.root;
        }
        toggleHidden(e) {
            var t;
            (t = this.nodes.root) == null || t.classList.toggle(Qe.hidden, e);
        }
    }
    var Z = ((n) => ((n.Closed = "closed"), (n.ClosedOnActivate = "closed-on-activate"), n))(Z || {});
    const U = te("ce-popover"),
        _ = {
            popover: U(),
            popoverContainer: U("container"),
            popoverOpenTop: U(null, "open-top"),
            popoverOpenLeft: U(null, "open-left"),
            popoverOpened: U(null, "opened"),
            search: U("search"),
            nothingFoundMessage: U("nothing-found-message"),
            nothingFoundMessageDisplayed: U("nothing-found-message", "displayed"),
            items: U("items"),
            overlay: U("overlay"),
            overlayHidden: U("overlay", "hidden"),
            popoverNested: U(null, "nested"),
            getPopoverNestedClass: (n) => U(null, `nested-level-${n.toString()}`),
            popoverInline: U(null, "inline"),
            popoverHeader: U("header"),
        };
    var he = ((n) => (
        (n.NestingLevel = "--nesting-level"), (n.PopoverHeight = "--popover-height"), (n.InlinePopoverWidth = "--inline-popover-width"), (n.TriggerItemLeft = "--trigger-item-left"), (n.TriggerItemTop = "--trigger-item-top"), n
    ))(he || {});
    const $t = te("ce-popover-item-html"),
        Yt = { root: $t(), hidden: $t(null, "hidden") };
    class Ee extends Ge {
        constructor(e, t) {
            var o, i;
            super(e),
                (this.nodes = { root: d.make("div", Yt.root) }),
                this.nodes.root.appendChild(e.element),
                e.name && (this.nodes.root.dataset.itemName = e.name),
                e.hint !== void 0 &&
                    ((o = t == null ? void 0 : t.hint) == null ? void 0 : o.enabled) !== !1 &&
                    this.addHint(this.nodes.root, { ...e.hint, position: ((i = t == null ? void 0 : t.hint) == null ? void 0 : i.position) || "right" });
        }
        getElement() {
            return this.nodes.root;
        }
        toggleHidden(e) {
            var t;
            (t = this.nodes.root) == null || t.classList.toggle(Yt.hidden, e);
        }
        getControls() {
    ...
    class Wt extends be {
        constructor(e, t = {}) {
            super(),
                ...
                (this.nodes = {}),
                (this.nodes.popoverContainer = d.make("div", [_.popoverContainer])),
                (this.nodes.nothingFoundMessage = d.make("div", [_.nothingFoundMessage], { textContent: this.messages.nothingFound })),
                this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage),
                (this.nodes.items = d.make("div", [_.items])),
                this.items.forEach((o) => {
                    const i = o.getElement();
                    i !== null && this.nodes.items.appendChild(i);
                }),
                this.nodes.popoverContainer.appendChild(this.nodes.items),
                this.listeners.on(this.nodes.popoverContainer, "click", (o) => this.handleClick(o)),
                (this.nodes.popover = d.make("div", [_.popover, this.params.class])),
        ...
        show() {
            this.nodes.popover.classList.add(_.popoverOpened), this.search !== void 0 && this.search.focus();
        }
        hide() {
            this.nodes.popover.classList.remove(_.popoverOpened), this.nodes.popover.classList.remove(_.popoverOpenTop), this.itemsDefault.forEach((e) => e.reset()), this.search !== void 0 && this.search.clear(), this.emit(Z.Closed);
        }
        destroy() {
            var e;
        ...
        buildItems(e) {
            return e.map((t) => {
                switch (t.type) {
                    ...
                    default:
                        return new ne(t, this.itemsRenderParams[A.Default]);
                }
            });
        }
        getTargetItem(e) {
            return this.items
                .filter((t) => t instanceof ne || t instanceof Ee)
                .find((t) => {
        ...
        toggleItemActivenessIfNeeded(e) {
            if (e instanceof ne && (e.toggle === !0 && e.toggleActive(), typeof e.toggle == "string")) {
    ...
    var Ne = ((n) => ((n.Search = "search"), n))(Ne || {});
    const et = te("cdx-search-field"),
        tt = { wrapper: et(), icon: et("icon"), input: et("input") };
    class Si extends be {
        constructor({ items: e, placeholder: t }) {
            super(), (this.listeners = new ke()), (this.items = e), (this.wrapper = d.make("div", tt.wrapper));
            const o = d.make("div", tt.icon, { innerHTML: xi });
            (this.input = d.make("input", tt.input, { placeholder: t, tabIndex: -1 })),
                this.wrapper.appendChild(o),
                this.wrapper.appendChild(this.input),
                this.listeners.on(this.input, "input", () => {
                    (this.searchQuery = this.input.value), this.emit(Ne.Search, { query: this.searchQuery, items: this.foundItems });
                });
        }
        getElement() {
            return this.wrapper;
        ...
        clear() {
            (this.input.value = ""), (this.searchQuery = ""), this.emit(Ne.Search, { query: "", items: this.foundItems });
        }
        destroy() {
    ...
    var Ii = Object.defineProperty,
        ...
        Ai = (n, e, t, o) => {
            for (var i = o > 1 ? void 0 : o ? Mi(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
            return o && i && Ii(e, t, i), i;
        };
    const Kt = class fo extends Wt {
        constructor(e, t) {
            super(e, t),
                (this.nestingLevel = 0),
                ...
                (this.onSearch = (o) => {
                    ...
                    this.items.forEach((a) => {
                        let c = !1;
                        a instanceof ne ? (c = !o.items.includes(a)) : (a instanceof jt || a instanceof Ee) && (c = s || !i), a.toggleHidden(c);
                    }),
                ...
                this.nestingLevel > 0 && this.nodes.popover.classList.add(_.popoverNested),
                e.scopeElement !== void 0 && (this.scopeElement = e.scopeElement),
                this.nodes.popoverContainer !== null && this.listeners.on(this.nodes.popoverContainer, "mouseover", (o) => this.handleHover(o)),
                e.searchable && this.addSearch(),
                e.flippable !== !1 && ((this.flipper = new se({ items: this.flippableElements, focusedItemClass: L.focused, allowedKeys: [w.TAB, w.UP, w.DOWN, w.ENTER] })), this.flipper.onFlip(this.onFlip));
        }
        hasFocus() {
        ...
        show() {
            var e;
            this.nodes.popover.style.setProperty(he.PopoverHeight, this.size.height + "px"),
                this.shouldOpenBottom || this.nodes.popover.classList.add(_.popoverOpenTop),
                this.shouldOpenRight || this.nodes.popover.classList.add(_.popoverOpenLeft),
                super.show(),
        ...
        setTriggerItemPosition(e, t) {
            const o = t.getElement(),
                ...
                s = this.offsetTop + i;
            e.style.setProperty(he.TriggerItemTop, s + "px");
        }
        ...
        showNestedPopoverForItem(e) {
            var o;
            (this.nestedPopover = new fo({ searchable: e.isChildrenSearchable, items: e.children, nestingLevel: this.nestingLevel + 1, flippable: e.isChildrenFlippable, messages: this.messages })),
                e.onChildrenOpen(),
            ...
            return (
                ...
                t.style.setProperty(he.NestingLevel, this.nestedPopover.nestingLevel.toString()),
        ...
        get size() {
            ...
            (t.style.visibility = "hidden"), (t.style.position = "absolute"), (t.style.top = "-1000px"), t.classList.add(_.popoverOpened), (i = t.querySelector("." + _.popoverNested)) == null || i.remove(), document.body.appendChild(t);
            const o = t.querySelector("." + _.popoverContainer);
            return (e.height = o.offsetHeight), (e.width = o.offsetWidth), t.remove(), e;
        }
        get flippableElements() {
            return this.items
                .map((t) => {
                    if (t instanceof ne) return t.getElement();
                    if (t instanceof Ee) return t.getControls();
                })
                .flat()
                .filter((t) => t != null);
        }
        addSearch() {
            (this.search = new Si({ items: this.itemsDefault, placeholder: this.messages.search })), this.search.on(Ne.Search, this.onSearch);
            const e = this.search.getElement();
            e.classList.add(_.search), this.nodes.popoverContainer.insertBefore(e, this.nodes.popoverContainer.firstChild);
        }
        toggleNothingFoundMessage(e) {
            this.nodes.nothingFoundMessage.classList.toggle(_.nothingFoundMessageDisplayed, e);
        }
    };
    Ai([ce], Kt.prototype, "size", 1);
    let ot = Kt;
    class Oi extends ot {
        constructor(e) {
            const t = !de();
            super({ ...e, class: _.popoverInline }, { [A.Default]: { wrapperTag: "button", hint: { position: "top", alignment: "center", enabled: t } }, [A.Html]: { hint: { position: "top", alignment: "center", enabled: t } } }),
                this.items.forEach((o) => {
                    (!(o instanceof ne) && !(o instanceof Ee)) || (o.hasChildren && o.isChildrenOpen && this.showNestedItems(o));
                });
        }
        get offsetLeft() {
        ...
        show() {
            this.nestingLevel === 0 && this.nodes.popover.style.setProperty(he.InlinePopoverWidth, this.size.width + "px"), super.show();
        }
        handleHover() {}
        setTriggerItemPosition(e, t) {
            const o = t.getElement(),
                i = o ? o.offsetLeft : 0,
                s = this.offsetLeft + i;
            e.style.setProperty(he.TriggerItemLeft, s + "px");
        }
        showNestedItems(e) {
        ...
        showNestedPopoverForItem(e) {
            ...
            return t.getElement().classList.add(_.getPopoverNestedClass(t.nestingLevel)), t;
        }
        handleItemClick(e) {
            var t;
    ...
    const Xt = class Ie {
        ...
        lock() {
            We ? this.lockHard() : document.body.classList.add(Ie.CSS.scrollLocked);
        }
        unlock() {
            We ? this.unlockHard() : document.body.classList.remove(Ie.CSS.scrollLocked);
        }
        lockHard() {
            (this.scrollPosition = window.pageYOffset), document.documentElement.style.setProperty("--window-scroll-offset", `${this.scrollPosition}px`), document.body.classList.add(Ie.CSS.scrollLockedHard);
        }
        unlockHard() {
            document.body.classList.remove(Ie.CSS.scrollLockedHard), this.scrollPosition !== null && window.scrollTo(0, this.scrollPosition), (this.scrollPosition = null);
        }
    };
    Xt.CSS = { scrollLocked: "ce-scroll-locked", scrollLockedHard: "ce-scroll-locked--hard" };
    let Li = Xt;
    const it = te("ce-popover-header"),
        st = { root: it(), text: it("text"), backButton: it("back-button") };
    class _i {
        constructor({ text: e, onBackButtonClick: t }) {
            (this.listeners = new ke()),
                (this.text = e),
                (this.onBackButtonClick = t),
                (this.nodes = { root: d.make("div", [st.root]), backButton: d.make("button", [st.backButton]), text: d.make("div", [st.text]) }),
                (this.nodes.backButton.innerHTML = pi),
    ...
    class Vt extends Wt {
        constructor(e) {
            super(e, { [A.Default]: { hint: { enabled: !1 } }, [A.Html]: { hint: { enabled: !1 } } }),
                (this.scrollLocker = new Li()),
                (this.history = new Ni()),
                (this.isHidden = !0),
                (this.nodes.overlay = d.make("div", [_.overlay, _.overlayHidden])),
        ...
        show() {
            this.nodes.overlay.classList.remove(_.overlayHidden), super.show(), this.scrollLocker.lock(), (this.isHidden = !1);
        }
        hide() {
            this.isHidden || (super.hide(), this.nodes.overlay.classList.add(_.overlayHidden), this.scrollLocker.unlock(), this.history.reset(), (this.isHidden = !0));
        }
        destroy() {
            super.destroy(), this.scrollLocker.unlock();
        }
        showNestedItems(e) {
            this.updateItemsAndHeader(e.children, e.title), this.history.push({ title: e.title, items: e.children });
        }
    ...
    class Pi extends y {
        ...
        make() {
            (this.nodes.wrapper = d.make("div", [this.CSS.settings])), this.eventsDispatcher.on(ve, this.close);
        }
        destroy() {
            this.removeAllNodes(), this.listeners.destroy(), this.eventsDispatcher.off(ve, this.close);
        }
        async open(e = this.Editor.BlockManager.currentBlock) {
            ...
            (this.popover = new i({
                ...
                messages: { nothingFound: H.ui($.ui.popover, "Nothing found"), search: H.ui($.ui.popover, "Filter") },
            })),
        ...
        async getTunesItems(e, t, o) {
            const i = [];
            o !== void 0 && o.length > 0 && (i.push(...o), i.push({ type: A.Separator }));
            const s = Array.from(this.Editor.Tools.blockTools.values()),
                l = (await Lt(e, s)).reduce(
                    (a, c) => (
                        c.toolbox.forEach((u) => {
                            a.push({
                                icon: u.icon,
                                title: H.t($.toolNames, u.title),
                                name: c.name,
                                closeOnActivate: !0,
                                onActivate: async () => {
            ...
            return (
                l.length > 0 && (i.push({ icon: Ut, name: "convert-to", title: H.ui($.ui.popover, "Convert to"), children: { searchable: !0, items: l } }), i.push({ type: A.Separator })),
                i.push(...t),
                i.map((a) => this.resolveTuneAliases(a))
            );
        }
        resolveTuneAliases(e) {
            if (e.type === A.Separator || e.type === A.Html) return e;
            const t = di(e, { label: "title" });
                            ...
                            r(a, [
                                {
                                    ...
                                    value: function (c) {
                                        ...
                                        for (var g in a.supportedCommands) this.commands[g] || (this.commands[g] = !1);
                                    },
                                },
                                {
                                    key: "execute",
                                    value: function (c) {
                                        var u,
                                            h = { CMD: c.ctrlKey || c.metaKey, SHIFT: c.shiftKey, ALT: c.altKey },
                                            p = !0;
                                        for (u in this.commands) this.commands[u] !== h[u] && (p = !1);
                                        var g,
                                            f = !0;
                                        for (g in this.keys) f = f && c.keyCode === a.keyCodes[g];
                                        p && f && this.callback(c);
                                    },
                                },
                                {
    ...
    class Fi {
        ...
        add(e) {
            ...
            const o = new Ri({ name: e.name, on: e.on, callback: e.handler }),
    ...
    var Hi = Object.defineProperty,
        ...
        Zt = (n, e, t, o) => {
            for (var i = o > 1 ? void 0 : o ? zi(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
            return o && i && Hi(e, t, i), i;
        },
        Pe = ((n) => ((n.Opened = "toolbox-opened"), (n.Closed = "toolbox-closed"), (n.BlockAdded = "toolbox-block-added"), n))(Pe || {});
    const nt = class go extends be {
        constructor({ api: e, tools: t, i18nLabels: o }) {
            super(),
                ...
                (this.nodes = { toolbox: d.make("div", go.CSS.toolbox) }),
                this.initPopover(),
                this.api.events.on(ve, this.handleMobileLayoutToggle);
        }
        get isEmpty() {
        ...
        destroy() {
            ...
            super.destroy(),
                ...
                this.api.events.off(ve, this.handleMobileLayoutToggle);
        }
        ...
        initPopover() {
            var t;
            const e = de() ? Vt : ot;
            (this.popover = new e({ scopeElement: this.api.ui.nodes.redactor, searchable: !0, messages: { nothingFound: this.i18nLabels.nothingFound, search: this.i18nLabels.filter }, items: this.toolboxItemsToBeDisplayed })),
                this.popover.on(Z.Closed, this.onPopoverClose),
        ...
        get toolboxItemsToBeDisplayed() {
            const e = (t, o) => ({
                icon: t.icon,
                title: H.t($.toolNames, t.title || Ae(o.name)),
                name: o.name,
                onActivate: () => {
                    this.toolButtonActivated(o.name, t.data);
                },
                secondaryLabel: o.shortcut ? $e(o.shortcut) : "",
            });
        ...
        removeAllShortcuts() {
            this.toolsToBeDisplayed.forEach((e) => {
                const t = e.shortcut;
                t && ue.remove(this.api.ui.nodes.redactor, t);
            });
        }
        async insertNewBlock(e, t) {
            ...
            l.call(Q.APPEND_CALLBACK), this.api.caret.setToBlock(s), this.emit("toolbox-block-added", { block: l }), this.api.toolbar.close();
        }
    };
    Zt([ce], nt.prototype, "toolsToBeDisplayed", 1), Zt([ce], nt.prototype, "toolboxItemsToBeDisplayed", 1);
    let Ui = nt;
    ...
    class $i extends y {
        ...
        get blockTunesToggler() {
            return { hide: () => this.nodes.settingsToggler.classList.add(this.CSS.settingsTogglerHidden), show: () => this.nodes.settingsToggler.classList.remove(this.CSS.settingsTogglerHidden) };
        }
        toggleReadOnly(e) {
            e
                ? (this.destroy(), this.Editor.BlockSettings.destroy(), this.disableModuleBindings())
                : window.requestIdleCallback(
                      () => {
        ...
        close() {
            ...
            this.Editor.ReadOnly.isEnabled ||
                ((e = this.nodes.wrapper) == null || e.classList.remove(this.CSS.toolbarOpened), this.blockActions.hide(), (t = this.toolboxInstance) == null || t.close(), this.Editor.BlockSettings.close(), this.reset());
        }
        reset() {
        ...
        async make() {
            (this.nodes.wrapper = d.make("div", this.CSS.toolbar)),
                ...
                (this.nodes.plusButton = d.make("div", this.CSS.plusButton, { innerHTML: wi })),
                d.append(this.nodes.actions, this.nodes.plusButton),
                this.readOnlyMutableListeners.on(
                    this.nodes.plusButton,
                    "click",
                    () => {
                        Le(!0), this.plusButtonClicked();
                    },
                    !1
                );
            const e = d.make("div");
            e.appendChild(document.createTextNode(H.ui($.ui.toolbar.toolbox, "Add"))),
                e.appendChild(d.make("div", this.CSS.plusButtonShortcut, { textContent: "/" })),
                _e(this.nodes.plusButton, e, { hidingDelay: 400 }),
                (this.nodes.settingsToggler = d.make("span", this.CSS.settingsToggler, { innerHTML: vi })),
                d.append(this.nodes.actions, this.nodes.settingsToggler);
            const t = d.make("div"),
                o = d.text(H.ui($.ui.blockTunes.toggler, "Click to tune")),
                i = await ji("Slash", "/");
            t.appendChild(o),
                t.appendChild(d.make("div", this.CSS.plusButtonShortcut, { textContent: $e(`CMD + ${i}`) })),
                _e(this.nodes.settingsToggler, t, { hidingDelay: 400 }),
        ...
        makeToolbox() {
            return (
                (this.toolboxInstance = new Ui({ api: this.Editor.API.methods, tools: this.Editor.Tools.blockTools, i18nLabels: { filter: H.ui($.ui.popover, "Filter"), nothingFound: H.ui($.ui.popover, "Nothing found") } })),
                this.toolboxInstance.on(Pe.Opened, () => {
                    this.Editor.UI.nodes.wrapper.classList.add(this.CSS.openedToolboxHolderModifier);
                }),
                this.toolboxInstance.on(Pe.Closed, () => {
                    this.Editor.UI.nodes.wrapper.classList.remove(this.CSS.openedToolboxHolderModifier);
                }),
                this.toolboxInstance.on(Pe.BlockAdded, ({ block: e }) => {
        ...
        enableModuleBindings() {
            this.readOnlyMutableListeners.on(
                ...
                (e) => {
                    var t;
                    e.stopPropagation(), this.settingsTogglerClicked(), (t = this.toolboxInstance) != null && t.opened && this.toolboxInstance.close(), Le(!0);
                },
                !0
            ),
                de() ||
                    this.eventsDispatcher.on(Gt, (e) => {
                        var t;
    ...
    var re = ((n) => ((n[(n.Block = 0)] = "Block"), (n[(n.Inline = 1)] = "Inline"), (n[(n.Tune = 2)] = "Tune"), n))(re || {}),
        De = ((n) => ((n.Shortcut = "shortcut"), (n.Toolbox = "toolbox"), (n.EnabledInlineTools = "inlineToolbar"), (n.EnabledBlockTunes = "tunes"), (n.Config = "config"), n))(De || {}),
        Jt = ((n) => ((n.Shortcut = "shortcut"), (n.SanitizeConfig = "sanitize"), n))(Jt || {}),
        pe = ((n) => ((n.IsEnabledLineBreaks = "enableLineBreaks"), (n.Toolbox = "toolbox"), (n.ConversionConfig = "conversionConfig"), (n.IsReadOnlySupported = "isReadOnlySupported"), (n.PasteConfig = "pasteConfig"), n))(pe || {}),
        rt = ((n) => ((n.IsInline = "isInline"), (n.Title = "title"), n))(rt || {}),
        lt = ((n) => ((n.IsTune = "isTune"), n))(lt || {});
    class at {
        constructor({ name: e, constructable: t, config: o, api: i, isDefault: s, isInternal: r = !1, defaultPlaceholder: l }) {
        ...
        reset() {
            if (O(this.constructable.reset)) return this.constructable.reset();
        }
        prepare() {
            if (O(this.constructable.prepare)) return this.constructable.prepare({ toolName: this.name, config: this.settings });
        }
        get shortcut() {
        ...
        isInline() {
            return this.type === re.Inline;
        }
        isBlock() {
            return this.type === re.Block;
        }
        isTune() {
            return this.type === re.Tune;
        }
    }
    class Yi extends y {
        constructor({ config: e, eventsDispatcher: t }) {
            super({ config: e, eventsDispatcher: t }), (this.CSS = { inlineToolbar: "ce-inline-toolbar" }), (this.opened = !1), (this.popover = null), (this.toolbarVerticalMargin = de() ? 20 : 6), (this.toolsInstances = new Map());
        }
        toggleReadOnly(e) {
            e
                ? this.destroy()
        ...
        close() {
            ...
            this.opened &&
                (this.Editor.ReadOnly.isEnabled ||
                    (Array.from(this.toolsInstances.entries()).forEach(([o, i]) => {
                        const s = this.getToolShortcut(o);
                        s && ue.remove(this.Editor.UI.nodes.redactor, s), O(i.clear) && i.clear();
                    }),
        ...
        make() {
            (this.nodes.wrapper = d.make("div", [this.CSS.inlineToolbar, ...(this.isRtl ? [this.Editor.UI.CSS.editorRtlFix] : [])])), d.append(this.Editor.UI.nodes.wrapper, this.nodes.wrapper);
        }
        async open() {
            var t;
            ...
            (this.popover = new Oi({ items: e, scopeElement: this.Editor.API.methods.ui.nodes.redactor, messages: { nothingFound: H.ui($.ui.popover, "Nothing found"), search: H.ui($.ui.popover, "Filter") } })),
        ...
        move(e) {
            const t = b.rect,
                ...
                i = { x: t.x - o.x, y: t.y + t.height - o.top + this.toolbarVerticalMargin };
        ...
        allowedToShow() {
            ...
            if (i === null || (t && e.includes(i.tagName)) || i.closest('[contenteditable="true"]') === null) return !1;
        ...
        async getInlineTools() {
            const e = b.get(),
                ...
                o = Array.from(t.tool.inlineTools.values()),
                i = [];
            ...
            for (let s = 0; s < o.length; s++) {
                ...
                const u = c !== void 0 ? $e(c) : void 0,
                    h = H.t($.toolNames, r.title || Ae(r.name));
                [a].flat().forEach((p) => {
                    var f, k;
                    const g = {
                        name: r.name,
                        ...
                        hint: { title: h, description: u },
                    };
                    if (d.isElement(p)) {
                        const S = { ...g, element: p, type: A.Html };
                        if (O(l.renderActions)) {
                            const I = l.renderActions();
                            S.children = { isOpen: (f = l.checkState) == null ? void 0 : f.call(l, b.get()), isFlippable: !1, items: [{ type: A.Html, element: I }] };
                        } else (k = l.checkState) == null || k.call(l, b.get());
                        i.push(S);
                    } else if (p.type === A.Html) i.push({ ...g, ...p, type: A.Html });
                    else if (p.type === A.Separator) i.push({ type: A.Separator });
                    else {
                        const S = { ...g, ...p, type: A.Default };
                        "children" in S && s !== 0 && i.push({ type: A.Separator }), i.push(S), "children" in S && s < o.length - 1 && i.push({ type: A.Separator });
                    }
                });
            }
            return i;
        ...
        getToolShortcut(e) {
            ...
            return Array.from(i.keys()).includes(e) ? this.inlineTools[e][Jt.Shortcut] : o == null ? void 0 : o.shortcut;
        }
        enableShortcuts(e, t) {
            ue.add({
                name: t,
    ...
    function Fe(n) {
        ...
        const [t, o] = Qt();
        return t === null ? !1 : eo(n, t, o, "right");
    }
    class Wi extends y {
        keydown(e) {
        ...
        beforeKeydownProcessing(e) {
            this.needToolbarClosing(e) && vt(e.keyCode) && (this.Editor.Toolbar.close(), e.ctrlKey || e.metaKey || e.altKey || e.shiftKey || this.Editor.BlockSelection.clearSelection(e));
        }
        keyup(e) {
        ...
        enter(e) {
            const { BlockManager: t, UI: o } = this.Editor,
                i = t.currentBlock;
            if (i === void 0 || i.tool.isLineBreaksEnabled || (o.someToolbarOpened && o.someFlipperButtonFocused) || (e.shiftKey && !We)) return;
            let s = i;
            i.currentInput !== void 0 && Re(i.currentInput) && !i.hasMedia
                ? this.Editor.BlockManager.insertDefaultBlockAtIndex(this.Editor.BlockManager.currentBlockIndex)
                : i.currentInput && Fe(i.currentInput)
                ? (s = this.Editor.BlockManager.insertDefaultBlockAtIndex(this.Editor.BlockManager.currentBlockIndex + 1))
        ...
        backspace(e) {
            ...
            if (i === void 0 || !b.isCollapsed || !i.currentInput || !Re(i.currentInput)) return;
            ...
            _t(s, i) ? this.mergeBlocks(s, i) : o.setToBlock(s, o.positions.END);
        }
        delete(e) {
            const { BlockManager: t, Caret: o } = this.Editor,
                { currentBlock: i, nextBlock: s } = t;
            if (!b.isCollapsed || !Fe(i.currentInput)) return;
            ...
            _t(i, s) ? this.mergeBlocks(i, s) : o.setToBlock(s, o.positions.START);
        }
        mergeBlocks(e, t) {
        ...
        arrowRightAndDown(e) {
            const t = se.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === w.TAB);
            if (this.Editor.UI.someToolbarOpened && t) return;
            this.Editor.Toolbar.close();
            const { currentBlock: o } = this.Editor.BlockManager,
                s = ((o == null ? void 0 : o.currentInput) !== void 0 ? Fe(o.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
        ...
        arrowLeftAndUp(e) {
            if (this.Editor.UI.someToolbarOpened) {
                if (se.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === w.TAB)) return;
                this.Editor.UI.closeAllToolbars();
            }
            this.Editor.Toolbar.close();
            const { currentBlock: t } = this.Editor.BlockManager,
                i = ((t == null ? void 0 : t.currentInput) !== void 0 ? Re(t.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
        ...
        needToolbarClosing(e) {
            const t = e.keyCode === w.ENTER && this.Editor.Toolbar.toolbox.opened,
                o = e.keyCode === w.ENTER && this.Editor.BlockSettings.opened,
                i = e.keyCode === w.ENTER && this.Editor.InlineToolbar.opened,
                s = e.keyCode === w.TAB;
    ...
    class Vi extends y {
        ...
        prepare() {
            ...
            (this._blocks = new Proxy(e, { set: ct.set, get: ct.get })), this.listeners.on(document, "copy", (t) => this.Editor.BlockEvents.handleCommandC(t));
        }
        toggleReadOnly(e) {
        ...
        composeBlock({ tool: e, data: t = {}, id: o = void 0, tunes: i = {} }) {
            const s = this.Editor.ReadOnly.isEnabled,
                ...
                l = new D({ id: o, data: t, tool: r, api: this.Editor.API, readOnly: s, tunesData: i }, this.eventsDispatcher);
            return (
                s ||
                    window.requestIdleCallback(
                        () => {
        ...
        insert({ id: e = void 0, tool: t = this.config.defaultBlock, data: o = {}, index: i, needToFocus: s = !0, replace: r = !1, tunes: l = {} } = {}) {
            let a = i;
            a === void 0 && (a = this.currentBlockIndex + (r ? 0 : 1));
            const c = this.composeBlock({ id: e, tool: t, data: o, tunes: l });
            return (
                r && this.blockDidMutated(to, this.getBlockByIndex(a), { index: a }),
                this._blocks.insert(a, c, r),
                this.blockDidMutated(oo, c, { index: a }),
                s ? (this.currentBlockIndex = a) : a <= this.currentBlockIndex && this.currentBlockIndex++,
                c
            );
        }
        insertMany(e, t = 0) {
        ...
        async update(e, t, o) {
            ...
            const i = await e.data,
                s = this.composeBlock({ id: e.id, tool: e.name, data: Object.assign({}, i, t ?? {}), tunes: o ?? e.tunes }),
                r = this.getBlockIndex(e);
            return this._blocks.replace(r, s), this.blockDidMutated(io, s, { index: r }), s;
        }
        replace(e, t, o) {
        ...
        insertDefaultBlockAtIndex(e, t = !1) {
            ...
            return (this._blocks[e] = o), this.blockDidMutated(oo, o, { index: e }), t ? (this.currentBlockIndex = e) : e <= this.currentBlockIndex && this.currentBlockIndex++, o;
        }
        insertAtEnd() {
        ...
        async mergeBlocks(e, t) {
            ...
            if (e.name === t.name && e.mergeable) {
                ...
                const [s] = Ve([i], e.tool.sanitizeConfig);
                o = s;
            } else if (e.mergeable && Oe(t, "export") && Oe(e, "import")) {
                const i = await t.exportDataAsString(),
                    s = q(i, e.tool.sanitizeConfig);
                o = Nt(s, e.tool.conversionConfig);
            }
        ...
        removeBlock(e, t = !0) {
            return new Promise((o) => {
                ...
                e.destroy(),
                    ...
                    this.blockDidMutated(to, e, { index: i }),
                    this.currentBlockIndex >= i && this.currentBlockIndex--,
                    this.blocks.length ? i === 0 && (this.currentBlockIndex = 0) : (this.unsetCurrentBlock(), t && this.insert()),
                    o();
            });
        }
        ...
        split() {
            const e = this.Editor.Caret.extractFragmentFromCaretPosition(),
                t = d.make("div");
            t.appendChild(e);
            const o = { text: d.isEmpty(t) ? "" : t.innerHTML };
        ...
        move(e, t = this.currentBlockIndex) {
            ...
            this._blocks.move(e, t), (this.currentBlockIndex = e), this.blockDidMutated(Ki, this.currentBlock, { fromIndex: t, toIndex: e });
        }
        async convert(e, t, o) {
            ...
            const r = await e.exportDataAsString(),
                l = q(r, s.sanitizeConfig);
            let a = Nt(l, s.conversionConfig);
        ...
        bindBlockEvents(e) {
            ...
            this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
                ...
                e.on("didMutated", (o) => this.blockDidMutated(io, o, { index: this.getBlockIndex(o) }));
        }
        disableModuleBindings() {
            this.readOnlyMutableListeners.clearAll();
        }
        ...
        blockDidMutated(e, t, o) {
            const i = new CustomEvent(e, { detail: { target: new J(t), ...o } });
            return this.eventsDispatcher.emit(St, { event: i }), t;
        }
    }
    class qi extends y {
        constructor() {
        ...
        get sanitizerConfig() {
            return { p: {}, h1: {}, h2: {}, h3: {}, h4: {}, h5: {}, h6: {}, ol: {}, ul: {}, li: {}, br: !0, img: { src: !0, width: !0, height: !0 }, a: { href: !0 }, b: {}, i: {}, u: {} };
        }
        ...
        clearSelection(e, t = !1) {
            ...
            if (this.anyBlockSelected && r && l && !b.isSelectionExists) {
                ...
                o.insertDefaultBlockAtIndex(a, !0),
...
`),
        ...
        handleCommandA(e) {
            ...
            this.needToSelectAll
                ? (e.preventDefault(), this.selectAllBlocks(), (this.needToSelectAll = !1), (this.readyToBlockSelection = !1))
                : this.readyToBlockSelection && (e.preventDefault(), this.selectBlock(t), (this.needToSelectAll = !0));
        }
        selectAllBlocks() {
    ...
    class He extends y {
        ...
        setToBlock(e, t = this.positions.DEFAULT, o = 0) {
            ...
            if (!r) return;
            const l = d.getDeepestNode(r, t === this.positions.END),
                a = d.getContentLength(l);
            switch (!0) {
        ...
        navigatePrevious(e = !1) {
            ...
            const { previousInput: i, currentInput: s } = t,
                r = s !== void 0 ? Re(s) : void 0,
                l = e || r || !t.focusable;
            return i && l ? (this.setToInput(i, this.positions.END), !0) : o !== null && l ? (this.setToBlock(o, this.positions.END), !0) : !1;
        }
        createShadow(e) {
            const t = document.createElement("span");
            t.classList.add(He.CSS.shadowCaret), e.insertAdjacentElement("beforeend", t);
        }
        restoreCaret(e) {
            const t = e.querySelector(`.${He.CSS.shadowCaret}`);
            if (!t) return;
            new b().expandToTag(t);
            const i = document.createRange();
    ...
    class Zi extends y {
        ...
        toggleBlockSelectedState(e = !0) {
            ...
            this.lastSelectedBlock || (this.lastSelectedBlock = this.firstSelectedBlock = t.currentBlock),
                this.firstSelectedBlock === this.lastSelectedBlock && ((this.firstSelectedBlock.selected = !0), o.clearCache(), b.get().removeAllRanges());
            const i = t.blocks.indexOf(this.lastSelectedBlock) + (e ? 1 : -1),
                s = t.blocks[i];
            s &&
                (this.lastSelectedBlock.selected !== s.selected ? ((s.selected = !0), o.clearCache()) : ((this.lastSelectedBlock.selected = !1), o.clearCache()),
    ...
    class es extends y {
        ...
        enable() {
            this.mutationObserver.observe(this.Editor.UI.nodes.redactor, { childList: !0, subtree: !0, characterData: !0, attributes: !0 }), (this.disabled = !1);
        }
        disable() {
        ...
        particularBlockChanged(e) {
            this.disabled ||
                !O(this.config.onChange) ||
                (this.batchingOnChangeQueue.set(`block:${e.detail.target.id}:event:${e.type}`, e),
                ...
                (this.batchingTimeout = setTimeout(() => {
                    ...
                    this.batchingOnChangeQueue.size === 1 ? (t = this.batchingOnChangeQueue.values().next().value) : (t = Array.from(this.batchingOnChangeQueue.values())),
                        this.config.onChange && this.config.onChange(this.Editor.API.methods, t),
                        this.batchingOnChangeQueue.clear();
                }, this.batchTime)));
        }
        redactorChanged(e) {
            this.eventsDispatcher.emit(Ke, { mutations: e });
        }
    }
    const so = class mo extends y {
        constructor() {
            super(...arguments),
                ...
                (this.processTool = (e) => {
                    try {
                        ...
                        if (!O(t.onPaste)) return;
                        this.getTagsConfig(e), this.getFilesConfig(e), this.getPatternsConfig(e);
                    } catch (t) {
                        C(`Paste handling for «${e.name}» Tool hasn't been set up because of the error`, "warn", t);
                    }
                }),
        ...
        async processText(e, t = !1) {
            ...
            s.map(async (a, c) => this.insertBlock(a, c === 0 && l)), i.currentBlock && o.setToBlock(i.currentBlock, o.positions.END);
        }
        setCallback() {
        ...
        collectTagNames(e) {
            return G(e) ? [e] : P(e) ? Object.keys(e) : [];
        }
        getTagsConfig(e) {
                ...
                o.push(...s),
                    s.forEach((r) => {
                        if (Object.prototype.hasOwnProperty.call(this.toolsTags, r)) {
                            C(`Paste handler for «${e.name}» Tool on «${r}» tag is skipped because it is already used by «${this.toolsTags[r].tool.name}» Tool.`, "warn");
                            return;
                        }
                        const l = P(i) ? i[r] : null;
                        this.toolsTags[r.toUpperCase()] = { tool: e, sanitizationConfig: l };
                    });
            }),
        ...
        getFilesConfig(e) {
            ...
            (!o && !i) ||
                (o && !Array.isArray(o) && (C(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), (o = [])),
                i && !Array.isArray(i) && (C(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), (i = [])),
                i && (i = i.filter((s) => (Eo(s) ? !0 : (C(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1)))),
                (this.toolsFiles[e.name] = { extensions: o || [], mimeTypes: i || [] }));
        }
        getPatternsConfig(e) {
            e.pasteConfig === !1 ||
                ...
                Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
                    o instanceof RegExp || C(`Pattern ${o} for «${e.name}» Tool is skipped because it should be a Regexp instance.`, "warn"), this.toolsPatterns.push({ key: t, pattern: o, tool: e });
                });
        }
        isNativeBehaviour(e) {
            return d.isNativeInput(e);
        ...
        async processFile(e) {
            const t = yo(e),
                o = Object.entries(this.toolsFiles).find(([r, { mimeTypes: l, extensions: a }]) => {
                    const [c, u] = e.type.split("/"),
                        h = a.find((g) => g.toLowerCase() === t.toLowerCase()),
                        p = l.find((g) => {
                            const [f, k] = g.split("/");
                            return f === c && (k === u || k === "*");
                        });
            ...
            return (
                ...
                this.getNodes(o)
                    .map((s) => {
                        ...
                        const { tags: c } = l.pasteConfig || { tags: [] },
                            u = c.reduce(
                                (g, f) => (
                                    this.collectTagNames(f).forEach((S) => {
                                        const I = P(f) ? f[S] : null;
                                        g[S.toLowerCase()] = I || {};
                                    }),
                                    g
                                ),
        ...
        async processInlinePaste(e) {
            const { BlockManager: t, Caret: o } = this.Editor,
                { content: i } = e;
            if (t.currentBlock && t.currentBlock.tool.isDefault && i.textContent.length < mo.PATTERN_PROCESSING_MAX_LENGTH) {
                const r = await this.processPattern(i.textContent);
                if (r) {
                    const l = t.currentBlock && t.currentBlock.tool.isDefault && t.currentBlock.isEmpty,
                        a = t.paste(r.tool, r.event, l);
                    o.setToBlock(a, o.positions.END);
                    return;
                }
            }
        ...
        async processPattern(e) {
            ...
            return t ? { event: this.composePasteEvent("pattern", { key: t.key, data: e }), tool: t.tool.name } : void 0;
        }
        insertBlock(e, t = !1) {
        ...
        insertEditorJSData(e) {
            ...
            Ve(e, (r) => i.blockTools.get(r).sanitizeConfig).forEach(({ tool: r, data: l }, a) => {
                let c = !1;
                a === 0 && (c = t.currentBlock && t.currentBlock.tool.isDefault && t.currentBlock.isEmpty);
                const u = t.insert({ tool: r, data: l, replace: c });
        ...
        processElementNode(e, t, o) {
            const i = Object.keys(this.toolsTags),
                ...
                l = this.tagsByTool[r == null ? void 0 : r.name] || [],
                a = i.includes(s.tagName),
                c = d.blockElements.includes(s.tagName.toLowerCase()),
                u = Array.from(s.children).some(({ tagName: p }) => i.includes(p) && !l.includes(p)),
                h = Array.from(s.children).some(({ tagName: p }) => d.blockElements.includes(p.toLowerCase()));
            if (!c && !a && !u) return o.appendChild(s), [...t, o];
            if ((a && !u) || (c && !h && !u)) return [...t, o, s];
        }
        getNodes(e) {
            ...
            const i = (s, r) => {
                ...
                switch ((l && d.isFragment(l) && (a = s.pop()), r.nodeType)) {
                    case Node.ELEMENT_NODE:
                        if (((o = this.processElementNode(r, s, a)), o)) return o;
                        break;
                    case Node.TEXT_NODE:
    ...
    so.PATTERN_PROCESSING_MAX_LENGTH = 450;
    let ts = so;
    class os extends y {
        constructor() {
        ...
        throwCriticalError() {
            throw new Ct(`To enable read-only mode all connected tools should support it. Tools ${this.toolsDontSupportReadOnly.join(", ")} don't support read-only mode.`);
        }
    }
    class Be extends y {
        constructor() {
        ...
        startSelection(e, t) {
            ...
            const s = [`.${D.CSS.content}`, `.${this.Editor.Toolbar.CSS.toolbar}`, `.${this.Editor.InlineToolbar.CSS.inlineToolbar}`],
                r = o.closest("." + this.Editor.UI.CSS.editorWrapper),
                l = s.some((a) => !!o.closest(a));
        ...
        scrollByZones(e) {
            if (
                ((this.inScrollZone = null),
                e <= this.HEIGHT_OF_SCROLL_ZONE && (this.inScrollZone = this.TOP_SCROLL_ZONE),
        ...
        genHTML() {
            ...
            return i.appendChild(s), o.appendChild(i), t.appendChild(o), (this.overlayRectangle = s), { container: t, overlay: o };
        }
        scrollVertical(e) {
        ...
        changingRectangle(e) {
            ...
            const { rightPos: t, leftPos: o, index: i } = this.genInfoForMouseSelection(),
                s = this.startX > t && this.mouseX > t,
                r = this.startX < o && this.mouseX < o;
            (this.rectCrossesBlocks = !(s || r)),
                this.isRectSelectionActivated || ((this.rectCrossesBlocks = !1), (this.isRectSelectionActivated = !0), this.shrinkRectangleToPoint(), (this.overlayRectangle.style.display = "block")),
                this.updateRectangleSize(),
                this.Editor.Toolbar.close(),
                i !== void 0 && (this.trySelectNextBlock(i), this.inverseSelection(), b.get().removeAllRanges());
        }
        ...
        updateRectangleSize() {
            this.mouseY >= this.startY
                ? ((this.overlayRectangle.style.top = `${this.startY - window.pageYOffset}px`), (this.overlayRectangle.style.bottom = `calc(100% - ${this.mouseY - window.pageYOffset}px`))
                : ((this.overlayRectangle.style.bottom = `calc(100% - ${this.startY - window.pageYOffset}px`), (this.overlayRectangle.style.top = `${this.mouseY - window.pageYOffset}px`)),
                this.mouseX >= this.startX
                    ? ((this.overlayRectangle.style.left = `${this.startX - window.pageXOffset}px`), (this.overlayRectangle.style.right = `calc(100% - ${this.mouseX - window.pageXOffset}px`))
                    : ((this.overlayRectangle.style.right = `calc(100% - ${this.startX - window.pageXOffset}px`), (this.overlayRectangle.style.left = `${this.mouseX - window.pageXOffset}px`));
        }
        genInfoForMouseSelection() {
            ...
            const l = this.Editor.BlockManager.lastBlock.holder.querySelector("." + D.CSS.content),
                a = Number.parseInt(window.getComputedStyle(l).width, 10) / 2,
                c = t - a,
                u = t + a;
            return { index: r, leftPos: c, rightPos: u };
        }
        ...
        trySelectNextBlock(e) {
            ...
            let a = r;
            o > 1 && (a = l ? i : s);
            const c = e > this.stackOfSelected[o - 1] && a === i,
                u = e < this.stackOfSelected[o - 1] && a === s,
                p = !(c || u || a === r);
            ...
            return new Promise((t) => {
                ...
                if (e.length === 0) i.insert();
                    ...
                    const s = e.map(({ type: r, data: l, tunes: a, id: c }) => {
                        ...
                        let u;
                        try {
                            u = i.composeBlock({ id: c, tool: r, data: l, tunes: a });
                        } catch (h) {
                            C(`Block «${r}» skipped because of plugins error`, "error", { data: l, error: h }), (l = this.composeStubDataForTool(r, l, c)), (r = o.stubTool), (u = i.composeBlock({ id: c, tool: r, data: l, tunes: a }));
                        }
                        return u;
                    });
                    i.insertMany(s);
    ...
    class ss extends y {
        async save() {
            ...
            try {
                ...
                const s = await Promise.all(i),
                    r = await Ve(s, (l) => t.blockTools.get(l).sanitizeConfig);
        ...
        makeOutput(e) {
            const t = [];
            return (
                e.forEach(({ id: o, tool: i, data: s, tunes: r, isValid: l }) => {
                    if (!l) {
                    ...
                    const a = { id: o, type: i, data: s, ...(!V(r) && { tunes: r }) };
                    t.push(a);
                }),
     ...
     */ class dt {
        ...
        constructor({ data: e, config: t, api: o, readOnly: i }) {
            (this.api = o),
                ...
                (this._placeholder = t.placeholder ? t.placeholder : dt.DEFAULT_PLACEHOLDER),
                (this._data = e ?? {}),
                (this._element = null),
        ...
        drawView() {
            ...
            return (
                ...
                this.readOnly || ((e.contentEditable = "true"), e.addEventListener("keyup", this.onKeyUp)),
                e
            );
        }
        render() {
    ...
    (ht.isInline = !0), (ht.title = "Bold");
    class ut {
        constructor() {
            (this.commandName = "italic"), (this.CSS = { button: "ce-inline-tool", buttonActive: "ce-inline-tool--active", buttonModifier: "ce-inline-tool--italic" }), (this.nodes = { button: null });
        }
        static get sanitize() {
            return { i: {} };
        }
        render() {
            return (
                (this.nodes.button = document.createElement("button")), (this.nodes.button.type = "button"), this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), (this.nodes.button.innerHTML = ki), this.nodes.button
            );
        }
        surround() {
            document.execCommand(this.commandName);
    ...
    class pt {
        ...
        render() {
            return (
                (this.nodes.button = document.createElement("button")), (this.nodes.button.type = "button"), this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), (this.nodes.button.innerHTML = zt), this.nodes.button
            );
        }
        renderActions() {
            return (
        ...
        checkState() {
            ...
            if (e) {
                (this.nodes.button.innerHTML = yi), this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
                const t = e.getAttribute("href");
                (this.nodes.input.value = t !== "null" ? t : ""), this.selection.save();
            } else (this.nodes.button.innerHTML = zt), this.nodes.button.classList.remove(this.CSS.buttonUnlink), this.nodes.button.classList.remove(this.CSS.buttonActive);
            return !!e;
        }
        clear() {
            this.closeActions();
        ...
        enterPressed(e) {
            ...
            if (!this.validateURL(t)) {
                this.notifier.show({ message: "Pasted link is not valid.", style: "error" }), C("Incorrect Link pasted", "warn", t);
                return;
            }
    ...
    class ro {
        constructor({ data: e, api: t }) {
            (this.CSS = { wrapper: "ce-stub", info: "ce-stub__info", title: "ce-stub__title", subtitle: "ce-stub__subtitle" }),
                (this.api = t),
        ...
        make() {
            const e = d.make("div", this.CSS.wrapper),
                ...
                s = d.make("div", this.CSS.subtitle, { textContent: this.subtitle });
            return (e.innerHTML = t), o.appendChild(i), o.appendChild(s), e.appendChild(o), e;
        }
    }
    ro.isReadOnlySupported = !0;
    class ls extends at {
        constructor() {
            super(...arguments), (this.type = re.Inline);
        }
        get title() {
    ...
    class as extends at {
        constructor() {
            super(...arguments), (this.type = re.Tune);
        }
        create(e, t) {
            return new this.constructable({ api: this.api, config: this.settings, block: t, data: e });
        }
    }
    class F extends Map {
        get blockTools() {
    ...
    class ft extends at {
        constructor() {
            super(...arguments), (this.type = re.Block), (this.inlineTools = new F()), (this.tunes = new F());
        }
        create(e, t, o) {
            return new this.constructable({ data: e, block: t, readOnly: o, api: this.api, config: this.settings });
        }
        ...
        get sanitizeConfig() {
            ...
            for (const i in e)
                if (Object.prototype.hasOwnProperty.call(e, i)) {
                    const s = e[i];
                    P(s) ? (o[i] = Object.assign({}, t, s)) : (o[i] = s);
                }
            return o;
        }
    ...
    lo([ce], ft.prototype, "sanitizeConfig", 1), lo([ce], ft.prototype, "baseSanitizeConfig", 1);
    class hs {
        constructor(e, t, o) {
        ...
        get(e) {
            const { class: t, isInternal: o = !1, ...i } = this.config[e],
                ...
                r = t[lt.IsTune];
            return new s({ name: e, constructable: t, config: i, api: this.api.getMethodsForTool(e, r), isDefault: e === this.editorConfig.defaultBlock, defaultPlaceholder: this.editorConfig.placeholder, isInternal: o });
        }
        getConstructor(e) {
            switch (!0) {
                case e[rt.IsInline]:
    ...
    class ao {
        ...
        render() {
            return { icon: ui, title: this.api.i18n.t("Move down"), onActivate: () => this.handleClick(), name: "move-down" };
        }
        handleClick() {
    ...
    class co {
        ...
        render() {
            return { icon: mi, title: this.api.i18n.t("Delete"), name: "delete", confirmation: { title: this.api.i18n.t("Click to delete"), onActivate: () => this.handleClick() } };
        }
        handleClick() {
    ...
    class ho {
        ...
        render() {
            return { icon: gi, title: this.api.i18n.t("Move up"), onActivate: () => this.handleClick(), name: "move-up" };
        }
        handleClick() {
            const e = this.api.blocks.getCurrentBlockIndex(),
    ...
    var us = Object.defineProperty,
        ...
        fs = (n, e, t, o) => {
            for (var i = o > 1 ? void 0 : o ? ps(e, t) : e, s = n.length - 1, r; s >= 0; s--) (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
    ...
    class uo extends y {
        ...
        async prepare() {
            if ((this.validateTools(), (this.config.tools = je({}, this.internalTools, this.config.tools)), !Object.prototype.hasOwnProperty.call(this.config, "tools") || Object.keys(this.config.tools).length === 0))
                throw Error("Can't start without tools");
            const e = this.prepareConfig();
            this.factory = new hs(e, this.config, this.Editor.API);
        ...
        get internalTools() {
            return {
                convertTo: { class: no, isInternal: !0 },
                link: { class: pt, isInternal: !0 },
                bold: { class: ht, isInternal: !0 },
                italic: { class: ut, isInternal: !0 },
                paragraph: { class: dt, inlineToolbar: !0, isInternal: !0 },
                stub: { class: ro, isInternal: !0 },
                moveUp: { class: ho, isInternal: !0 },
                delete: { class: co, isInternal: !0 },
                moveDown: { class: ao, isInternal: !0 },
            };
        }
        toolPrepareMethodSuccess(e) {
            ...
            if (t.isInline()) {
                ...
                if (i.length) {
                    C(`Incorrect Inline Tool: ${t.name}. Some of required methods is not implemented %o`, "warn", i), this.toolsUnavailable.set(t.name, t);
                    return;
                }
            }
        ...
        getListOfPrepareFunctions(e) {
            ...
            return (
                Object.entries(e).forEach(([o, i]) => {
                    t.push({ function: O(i.class.prepare) ? i.class.prepare : () => {}, data: { toolName: o, config: i.config } });
                }),
                t
            );
        }
        ...
        assignInlineToolsToBlockTool(e) {
            if (this.config.inlineToolbar !== !1) {
                if (e.enabledInlineTools === !0) {
                    e.inlineTools = new F(Array.isArray(this.config.inlineToolbar) ? this.config.inlineToolbar.map((t) => [t, this.inlineTools.get(t)]) : Array.from(this.inlineTools.entries()));
                    return;
                }
                Array.isArray(e.enabledInlineTools) && (e.inlineTools = new F(["convertTo", ...e.enabledInlineTools].map((t) => [t, this.inlineTools.get(t)])));
            }
        }
        assignBlockTunesToBlockTool(e) {
            if (e.enabledBlockTunes !== !1) {
                if (Array.isArray(e.enabledBlockTunes)) {
                    const t = new F(e.enabledBlockTunes.map((o) => [o, this.blockTunes.get(o)]));
                    e.tunes = new F([...t, ...this.blockTunes.internalTools]);
                    return;
                }
                if (Array.isArray(this.config.tunes)) {
                    const t = new F(this.config.tunes.map((o) => [o, this.blockTunes.get(o)]));
                    e.tunes = new F([...t, ...this.blockTunes.internalTools]);
                    return;
                }
...
`;
    class ms extends y {
        ...
        get contentRect() {
            ...
            return e ? ((this.contentRectCache = e.getBoundingClientRect()), this.contentRectCache) : { width: 650, left: 0, right: 0 };
        }
        async prepare() {
        ...
        get someFlipperButtonFocused() {
            return this.Editor.Toolbar.toolbox.hasFocus()
                ...
                : Object.entries(this.Editor)
                      .filter(([e, t]) => t.flipper instanceof se)
        ...
        setIsMobile() {
            ...
            e !== this.isMobile && this.eventsDispatcher.emit(ve, { isEnabled: this.isMobile }), (this.isMobile = e);
        }
        make() {
            (this.nodes.holder = d.getHolder(this.config.holder)),
                (this.nodes.wrapper = d.make("div", [this.CSS.editorWrapper, ...(this.isRtl ? [this.CSS.editorRtlFix] : [])])),
        ...
        loadStyles() {
            ...
            if (d.get(e)) return;
            const t = d.make("style", null, { id: e, textContent: gs.toString() });
        ...
        watchBlockHoveredEvents() {
            ...
            this.readOnlyMutableListeners.on(
                ...
                Ue((t) => {
                    ...
                    this.Editor.BlockSelection.anyBlockSelected || (o && e !== o && ((e = o), this.eventsDispatcher.emit(Gt, { block: this.Editor.BlockManager.getBlockByChildNode(o) })));
                }, 20),
                { passive: !0 }
            );
        }
        ...
        escapePressed(e) {
            this.Editor.BlockSelection.clearSelection(e),
                this.Editor.Toolbar.toolbox.opened
                    ? (this.Editor.Toolbar.toolbox.close(), this.Editor.Caret.setToBlock(this.Editor.BlockManager.currentBlock, this.Editor.Caret.positions.END))
        ...
        documentClicked(e) {
            ...
            const i = (l = this.Editor.BlockSettings.nodes.wrapper) == null ? void 0 : l.contains(t),
                s = (a = this.Editor.Toolbar.nodes.settingsToggler) == null ? void 0 : a.contains(t),
                r = i || s;
        ...
        selectionChanged() {
            ...
            (o.closest(`.${D.CSS.content}`) === null && (this.Editor.InlineToolbar.containsNode(o) || this.Editor.InlineToolbar.close(), !(o.dataset.inlineToolbar === "true"))) ||
                (this.Editor.BlockManager.currentBlock || this.Editor.BlockManager.setCurrentBlockByChildNode(o), this.Editor.InlineToolbar.tryToShow(!0));
        }
    ...
    const bs = {
        ...
        BlockSelection: qi,
        Caret: He,
        CrossBlockSelection: Zi,
        DragNDrop: Gi,
        ModificationsObserver: es,
        Paste: ts,
        ReadOnly: os,
    ...
    class ks {
        ...
        set configuration(e) {
            var o, i;
            P(e) ? (this.config = { ...e }) : (this.config = { holder: e }),
                Ye(!!this.config.holderId, "config.holderId", "config.holder"),
                this.config.holderId && !this.config.holder && ((this.config.holder = this.config.holderId), (this.config.holderId = null)),
                this.config.holder == null && (this.config.holder = "editorjs"),
                this.config.logLevel || (this.config.logLevel = mt.VERBOSE),
                vo(this.config.logLevel),
                Ye(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"),
            ...
            (this.config.placeholder = this.config.placeholder || !1),
                (this.config.sanitizer = this.config.sanitizer || { p: !0, b: !0, a: !0 }),
                ...
                (V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }),
                (this.config.readOnly = this.config.readOnly || !1),
                (o = this.config.i18n) != null && o.messages && H.setDictionary(this.config.i18n.messages),
        ...
        validate() {
            ...
            if (G(t) && !d.get(t)) throw Error(`element with ID «${t}» is missing. Pass correct holder's ID.`);
            if (t && P(t) && !d.isElement(t)) throw Error("«holder» value must be an Element node");
        }
        init() {
            this.constructModules(), this.configureModules();
        }
        async start() {
            await ["Tools", "UI", "BlockManager", "Paste", "BlockSelection", "RectangleSelection", "CrossBlockSelection", "ReadOnly"].reduce(
                (t, o) =>
                    t.then(async () => {
                        try {
                            await this.moduleInstances[o].prepare();
                        } catch (i) {
                            if (i instanceof Ct) throw new Error(i.message);
        ...
        constructModules() {
            Object.entries(bs).forEach(([e, t]) => {
                try {
                    this.moduleInstances[e] = new t({ config: this.configuration, eventsDispatcher: this.eventsDispatcher });
                } catch (o) {
     ...
     */ class vs {
        ...
        exportAPI(e) {
            ...
            t.forEach((s) => {
                ...
                Object.entries({ blocks: { clear: "clear", render: "render" }, caret: { focus: "focus" }, events: { on: "on", off: "off", emit: "emit" }, saver: { save: "save" } }).forEach(([s, r]) => {
