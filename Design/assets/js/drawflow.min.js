            ...
            class i {
                ...
                start() {
                    this.container.classList.add("parent-drawflow"),
                        ...
                        // this.container.addEventListener("mouseup", this.contextmenu.bind(this)),
                ...
                contextmenu(e) {
                    ...
                    if ((this.precanvas.getElementsByClassName("drawflow-delete").length && this.precanvas.getElementsByClassName("drawflow-delete")[0].remove(), this.node_selected || this.connection_selected)) {
                        ...
                        u.classList.add("drawflow-edit"),
                            (u.innerHTML = "y"),
                            this.node_selected && this.node_selected.appendChild(u),
                            this.connection_selected &&
                            (

                                this.precanvas.appendChild(u));
                        // Custom edit button End
                    }
                }
                ...
                contextmenuDel() {
                    ...
                    this.precanvas.getElementsByClassName("drawflow-edit").length && this.precanvas.getElementsByClassName("drawflow-edit")[0].remove();
                }
                key(e) {
