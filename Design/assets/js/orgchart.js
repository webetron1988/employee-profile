        ...
        !(function (e) {
            ...
            (t.prototype = {
                ...
                createNode: function (i) {
                    ...
                    n.nodeTemplate ? t.append(n.nodeTemplate(i)) : t.append(void 0 !== n.nodeTitle ? '<div class="org-box">' + '<div class="structure-tile">' + '<div class="dropdown dropdown-inline ml-auto org-chart-actions"> <a href="#" class="p-1 btn btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="ki ki-bold-more-hor"></i> </a> <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style=""><ul class="navi navi-hover my-0"><li class=""><a href="" class="edit-org-card text-dark-50"><img src="assets/media/images/edit-icon.svg" class="h-14 mr-2" alt=""> <span class="align-self-center">Edit</span></a></li> <li class=""><a id="btn-delete-nodes" class="text-dark-50"><i class="flaticon-delete mr-2"></i> <span class="align-self-center">Delete</span></a></li></ul></div></div> <figure><span><img src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-png-webinar-optimizing-for-success-google-business-webinar-13.png"></span></figure>' + '<h2 class="orgTitle">' + (i[n.nodeTitle] || "") + '</h2>' + '<h6 class="orgDesc">' + (i[n.nodeDesc] || "") + '</h6>' + '<div class="org-box-spans d-flex flex-wrap justify-content-center mb-3"><span class="text-success d-flex m-2"><img src="assets/media/images/user-success.svg" class="mr-1 h-12 align-self-center"> 36 Members</span><span class="text-warning d-flex m-2"><img class="mr-1 h-12 align-self-center" src="assets/media/images/bullet-calendar-warning.svg"> 500 Serving Notice</span><span class="text-danger d-flex m-2"><img class="mr-1 h-12 align-self-center" src="assets/media/images/portfolio-danger.svg"> 50 Critical positions</span></div>' + "</div>" + "</div>" : "");
